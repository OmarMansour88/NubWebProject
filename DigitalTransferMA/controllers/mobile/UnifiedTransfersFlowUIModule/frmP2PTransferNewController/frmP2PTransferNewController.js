...
//         ntf.navigate(response);  
        ...
        navMan.navigateTo("UnifiedTransfersFlowUIModule/frmP2PAcknowledgementNew");
      }
      else
      {
...
//         ntf.navigate(response); 
        ...
        navMan.navigateTo("UnifiedTransfersFlowUIModule/frmMFAValidationNew");
      }
    };
...
//     ntf.navigate();
    try {
      navMan.navigateTo("UnifiedTransfersFlowUIModule/"+previousForm.id);
    }
    catch(err) {
