...
define(['./activateP2PStore','./activateP2PBusinessController', 'DataValidationFramework/DataValidationHandler'],function(ActivateP2PStore, BusinessController,DataValidationHandler) {
  ...
  return {
	...
	*/ 
    setActivateScreenText: function()
    {
      ...
      try{
        ...
        this.view.imgIAgree.src="unchecked_box.png";
      }catch(err)
      {
        var errorObj =
            {
	...
	*/  
    checkTermsConditionEnabled :function() {
      var scope=this;
      try{
      if(this.view.imgIAgree.src==="unchecked_box.png")
      {
	...
	*/
    ...
    updateAmountValue : function () {
      ...
      scope.view.tbxAmount1.text = scope.businessController.getFormattedAmount(this._serviceParameters.getDepositAccounts.Object, "P2PContextJSON", this.view.tbxAmount1.text, getFieldKey);
  ...
  */
    setContactTypeDropdown:function()
    {
      ...
      else if(this.view.lblSelectedEmail.text==="Email")
      {
        this.selectOption2();
      }
  ...
  * @return : NA
  */
    setBasedOnContactType : function(selectedOption) {
      var scope=this;   
      try{
  ...
  */
    performMinimumDataFillValidation : function() {
      var scope = this;
      try{
      this.view.tbxNationalID.onKeyUp = function() {      
  ...
  */
    disableContinueButton : function() {
      var scope=this;
      try{
      if(this.view.flxActivate.isVisible===true && this.view.imgIAgree.src==="unchecked_box.png")
      {
	...
	*/
    validateData : function(dataValidator) {
      ...
      if(dataValidator === "" && scope.errorIdentifier !== 1){
        this.view.flxShowError.setVisibility(false);
        this.view.tbxNationalID.skin = "sknTbxSSPreg42424215px";
      }
	...
	*/
    validationData : function(dataValidator) {
      ...
      if(dataValidator === "" && scope.errorIdentifier !== 1){
        this.view.flxShowError.setVisibility(false);
        this.view.tbxNationalID.skin = "sknTbxSSPreg42424215px";
        this.view.tbxAmount1.skin="sknTbxSSPreg42424215px";
      }
      else if(dataValidator !== ""){
        this.invokedvfFieldErrorParser(dataValidator);
      }
	...
	*/
    updateContactTypeDetails : function(data) {
      ...
      this.view.lblSelectedValue.text = data[key[0]];
