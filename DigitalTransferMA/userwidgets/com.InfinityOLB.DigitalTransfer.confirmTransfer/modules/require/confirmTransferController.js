define(['./ParserUtilsManager','./ConfirmationUtility','./ConfirmationDAO'],function(ParserUtilsManager,ConfirmationUtility,ConfirmationDAO) {
  var frequencyType = "";
  return {
...
//             });
  ...
  */
    setUI :function (){
      ...
      if(scope.context.transferType === this.getFieldValue(this._transferFlow, "T2") || scope.context.transferType === this.getFieldValue(this._transferFlow, "T3")){
        scope.view.lblValue6.text = scope.view.lblValue6.text + "," + scope.context["countryCode"];
      }
  ...
  */
    ...
    setDocumentsValue : function(){
      ...
      this.view.lblValueDocName1.text = "None";
    ...
    setAddress : function(){
      ...
      if(address === "") 
        this.view.lblValue23.text = "None";
      else 
  ...
  */
    ...
    confirmTransfer:function(context){  
      ...
      this.ConfirmationDAO.createServiceLogic(objSvcName,objName,operationName,criteria,onSuccess.bind(this),self.onError);
