define(['./AcknowledgementComponentBusinessController','./AcknowledgementComponentStore'], function(BusinessController, AcknowledgementComponentStore) {
  ...
  return {
	...
	*/
    ...
    getProcessedDataForSegment:function () {
      var scope = this;
      var data = [];
      var fieldLabel = "",fieldValue = "", flxSeparator= "";
      for (var i=1;i<27;i++)
      {
