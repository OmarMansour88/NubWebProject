...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "Email", "objectService" : "Utility"};
    ...
    //For Operation 'sendKMSEmail' with service id 'sendEmail1885'
     Email.sendKMSEmail = function(params, onCompletion){
        return Email.customVerb('sendKMSEmail', params, onCompletion);
     };
    ...
    Email.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("Utility", "Email", options, metaDataSuccess, metaDataFailure);
    };
