...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "Users_2", "objectService" : "Login"};
    ...
    function Users_2(defaultValues) {
        var privateState = {};
        context["field"] = "id";
        context["metadata"] = (objectMetadata ? objectMetadata["id"] : null);
    ...
    BaseModel.isParentOf(Users_2);

    //Create new class level validator object
    BaseModel.Validator.call(Users_2);

    var registerValidatorBackup = Users_2.registerValidator;

    Users_2.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(Users_2.isValid(this, propName, val)) {
    ...
    //For Operation 'requestLoginMFAOTP' with service id 'RequestLoginMFAOTP1676'
     Users_2.requestLoginMFAOTP = function(params, onCompletion){
        return Users_2.customVerb('requestLoginMFAOTP', params, onCompletion);
     };

    //For Operation 'verifyLoginMFASecurityQuestions' with service id 'DBX_verifyCustomerSecurityQuestions9295'
     Users_2.verifyLoginMFASecurityQuestions = function(params, onCompletion){
        return Users_2.customVerb('verifyLoginMFASecurityQuestions', params, onCompletion);
     };

    //For Operation 'resetUserPassword' with service id 'resetDbxUserPassword2912'
     Users_2.resetUserPassword = function(params, onCompletion){
        return Users_2.customVerb('resetUserPassword', params, onCompletion);
     };

    //For Operation 'verifyOTPPreLogin' with service id 'VerifyOTPPreLogin6602'
     Users_2.verifyOTPPreLogin = function(params, onCompletion){
        return Users_2.customVerb('verifyOTPPreLogin', params, onCompletion);
     };

    //For Operation 'verifyUser' with service id 'VerifyUserAndSendMail8862'
     Users_2.verifyUser = function(params, onCompletion){
        return Users_2.customVerb('verifyUser', params, onCompletion);
     };

    //For Operation 'getPasswordLockoutSettings' with service id 'getPasswordLockoutSettings9051'
     Users_2.getPasswordLockoutSettings = function(params, onCompletion){
        return Users_2.customVerb('getPasswordLockoutSettings', params, onCompletion);
     };

    //For Operation 'verifyLoginMFAOTP' with service id 'VerifyLoginMFAOTP1345'
     Users_2.verifyLoginMFAOTP = function(params, onCompletion){
        return Users_2.customVerb('verifyLoginMFAOTP', params, onCompletion);
     };

    //For Operation 'getPasswordRulesAndPolicy' with service id 'getPasswordRulesAndPolicy6538'
     Users_2.getPasswordRulesAndPolicy = function(params, onCompletion){
        return Users_2.customVerb('getPasswordRulesAndPolicy', params, onCompletion);
     };

    //For Operation 'requestResetPasswordOTP' with service id 'RequestOTPPreLogin5436'
     Users_2.requestResetPasswordOTP = function(params, onCompletion){
        return Users_2.customVerb('requestResetPasswordOTP', params, onCompletion);
     };

    var relations = [];

    Users_2.relations = relations;

    Users_2.prototype.isValid = function() {
        return Users_2.isValid(this);
    };

    Users_2.prototype.objModelName = "Users_2";
     ...
     */
    Users_2.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("Login", "Users_2", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    Users_2.clone = function(objectToClone) {
        var clonedObj = new Users_2();
