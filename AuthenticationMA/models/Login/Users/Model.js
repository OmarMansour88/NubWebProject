...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "Users", "objectService" : "Login"};
    ...
    //For Operation 'getUserProfileImage' with service id 'GetUserProfileImage9129'
     Users.getUserProfileImage = function(params, onCompletion){
        return Users.customVerb('getUserProfileImage', params, onCompletion);
     };

    //For Operation 'verifyPin' with service id 'verifyPin2016'
     Users.verifyPin = function(params, onCompletion){
        return Users.customVerb('verifyPin', params, onCompletion);
     };
    ...
    Users.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("Login", "Users", options, metaDataSuccess, metaDataFailure);
    };
