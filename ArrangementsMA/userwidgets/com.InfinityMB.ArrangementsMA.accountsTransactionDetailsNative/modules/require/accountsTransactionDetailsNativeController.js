      ...
      if(this.currentTransactionType === "SwiftPayment") {
         ...
         */
	     frontCheckDownload: function(){
          ...
          serviceURL = serviceURL + "&customerId=" + reqParams.customerId + "&accountId=" + reqParams.accountId + "&transactionRef=" + reqParams.transactionRef + "&mediaType=" + reqParams.mediaType + "&transactionType=" + reqParams.transactionType + "&page=0";
		...
		backCheckDownload: function(){
          ...
          var authToken = KNYMobileFabric.currentClaimToken;
          var serviceURL = mfURL + "/objects/TransactionAdviceObject?Auth_Token=" + authToken;
          serviceURL = serviceURL + "&customerId=" + reqParams.customerId + "&accountId=" + reqParams.accountId + "&transactionRef=" + reqParams.transactionRef + "&mediaType=" + reqParams.mediaType + "&transactionType=" + reqParams.transactionType + "&page=1";
          kony.application.openURL(serviceURL);
        },
