...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "DITransactionsList", "objectService" : "DIHoldings"};
    ...
    function DITransactionsList(defaultValues) {
        var privateState = {};
        context["field"] = "accountID";
        context["metadata"] = (objectMetadata ? objectMetadata["accountID"] : null);
    ...
    BaseModel.isParentOf(DITransactionsList);

    //Create new class level validator object
    BaseModel.Validator.call(DITransactionsList);

    var registerValidatorBackup = DITransactionsList.registerValidator;

    DITransactionsList.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(DITransactionsList.isValid(this, propName, val)) {
    ...
    //For Operation 'DIgetRecent' with service id 'getAccountPendingAndPostedTransactions7824'
     DITransactionsList.DIgetRecent = function(params, onCompletion){
        return DITransactionsList.customVerb('DIgetRecent', params, onCompletion);
     };

    var relations = [];

    DITransactionsList.relations = relations;

    DITransactionsList.prototype.isValid = function() {
        return DITransactionsList.isValid(this);
    };

    DITransactionsList.prototype.objModelName = "DITransactionsList";
    DITransactionsList.prototype.objServiceName = "DIHoldings";
     ...
     */
    DITransactionsList.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("DIHoldings", "DITransactionsList", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    DITransactionsList.clone = function(objectToClone) {
        var clonedObj = new DITransactionsList();
        clonedObj.fromJsonInternal(objectToClone.toJsonInternal());
        return clonedObj;
    };

    return DITransactionsList;
});