...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "ArrangementPreferences_1", "objectService" : "Holdings"};
    ...
    function ArrangementPreferences_1(defaultValues) {
        var privateState = {};
        context["field"] = "accountNumber";
        context["metadata"] = (objectMetadata ? objectMetadata["accountNumber"] : null);
    ...
    BaseModel.isParentOf(ArrangementPreferences_1);

    //Create new class level validator object
    BaseModel.Validator.call(ArrangementPreferences_1);

    var registerValidatorBackup = ArrangementPreferences_1.registerValidator;

    ArrangementPreferences_1.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(ArrangementPreferences_1.isValid(this, propName, val)) {
    ...
    //For Operation 'deactivateP2P' with service id 'deactivateP2P9743'
     ArrangementPreferences_1.deactivateP2P = function(params, onCompletion){
        return ArrangementPreferences_1.customVerb('deactivateP2P', params, onCompletion);
     };

    //For Operation 'activateP2P' with service id 'activateP2PForUser8370'
     ArrangementPreferences_1.activateP2P = function(params, onCompletion){
        return ArrangementPreferences_1.customVerb('activateP2P', params, onCompletion);
     };

    //For Operation 'activateBillPay' with service id 'activateBillPaymentForUser1097'
     ArrangementPreferences_1.activateBillPay = function(params, onCompletion){
        return ArrangementPreferences_1.customVerb('activateBillPay', params, onCompletion);
     };

    //For Operation 'updateBillPayPreferredAccount' with service id 'updatePreferredBillPayAccount3351'
     ArrangementPreferences_1.updateBillPayPreferredAccount = function(params, onCompletion){
        return ArrangementPreferences_1.customVerb('updateBillPayPreferredAccount', params, onCompletion);
     };

    //For Operation 'updateP2PPreferredAccount' with service id 'updatePreferredP2PAccounts7402'
     ArrangementPreferences_1.updateP2PPreferredAccount = function(params, onCompletion){
        return ArrangementPreferences_1.customVerb('updateP2PPreferredAccount', params, onCompletion);
     };

    var relations = [];

    ArrangementPreferences_1.relations = relations;

    ArrangementPreferences_1.prototype.isValid = function() {
        return ArrangementPreferences_1.isValid(this);
    };

    ArrangementPreferences_1.prototype.objModelName = "ArrangementPreferences_1";
    ArrangementPreferences_1.prototype.objServiceName = "Holdings";
     ...
     */
    ArrangementPreferences_1.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("Holdings", "ArrangementPreferences_1", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    ArrangementPreferences_1.clone = function(objectToClone) {
        var clonedObj = new ArrangementPreferences_1();
        clonedObj.fromJsonInternal(objectToClone.toJsonInternal());
        return clonedObj;
    };

    return ArrangementPreferences_1;
});