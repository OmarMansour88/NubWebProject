define([], function(){
	...
	ArrangementDetailsRepository.prototype.getAccountsForAdmin = function(params, onCompletion){
		return ArrangementDetailsRepository.prototype.customVerb('getAccountsForAdmin', params, onCompletion);
	};
