...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "ArrangementPreferences", "objectService" : "Holdings"};
    ...
    function ArrangementPreferences(defaultValues) {
        var privateState = {};
        context["field"] = "accountHolder";
        context["metadata"] = (objectMetadata ? objectMetadata["accountHolder"] : null);
    ...
    BaseModel.isParentOf(ArrangementPreferences);

    //Create new class level validator object
    BaseModel.Validator.call(ArrangementPreferences);

    var registerValidatorBackup = ArrangementPreferences.registerValidator;

    ArrangementPreferences.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(ArrangementPreferences.isValid(this, propName, val)) {
    ...
    //For Operation 'UpdateDetails' with service id 'updateUserAccountSettingsOperation1645'
     ArrangementPreferences.UpdateDetails = function(params, onCompletion){
        return ArrangementPreferences.customVerb('UpdateDetails', params, onCompletion);
     };

    var relations = [];

    ArrangementPreferences.relations = relations;

    ArrangementPreferences.prototype.isValid = function() {
        return ArrangementPreferences.isValid(this);
    };

    ArrangementPreferences.prototype.objModelName = "ArrangementPreferences";
    ArrangementPreferences.prototype.objServiceName = "Holdings";
     ...
     */
    ArrangementPreferences.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("Holdings", "ArrangementPreferences", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    ArrangementPreferences.clone = function(objectToClone) {
        var clonedObj = new ArrangementPreferences();
