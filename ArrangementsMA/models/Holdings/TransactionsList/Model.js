...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "TransactionsList", "objectService" : "Holdings"};
    ...
    var setterFunctions = {
        ...
        Transaction: function(val, state) {
            context["field"] = "Transaction";
            context["metadata"] = (objectMetadata ? objectMetadata["Transaction"] : null);
            state['Transaction'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        Id: function(val, state) {
            context["field"] = "Id";
            context["metadata"] = (objectMetadata ? objectMetadata["Id"] : null);
    ...
    function TransactionsList(defaultValues) {
        var privateState = {};
        context["field"] = "accountID";
        context["metadata"] = (objectMetadata ? objectMetadata["accountID"] : null);
        ...
        context["field"] = "Transaction";
        context["metadata"] = (objectMetadata ? objectMetadata["Transaction"] : null);
        privateState.Transaction = defaultValues ?
            (defaultValues["Transaction"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["Transaction"], context) :
                null) :
            null;
        ...
        Object.defineProperties(this, {
            ...
            "Transaction": {
                get: function() {
                    context["field"] = "Transaction";
                    context["metadata"] = (objectMetadata ? objectMetadata["Transaction"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.Transaction, context);
                },
                set: function(val) {
                    setterFunctions['Transaction'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "Id": {
        ...
        this.fromJsonInternal = function(value) {
            ...
            privateState.Transaction = value ? (value["Transaction"] ? value["Transaction"] : null) : null;
            privateState.Id = value ? (value["Id"] ? value["Id"] : null) : null;
        };
    }

    //Setting BaseModel as Parent to this Model
    BaseModel.isParentOf(TransactionsList);

    //Create new class level validator object
    BaseModel.Validator.call(TransactionsList);

    var registerValidatorBackup = TransactionsList.registerValidator;

    TransactionsList.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(TransactionsList.isValid(this, propName, val)) {
    ...
    //For Operation 'getPostedUserTransactions' with service id 'searchTransactions1640'
     TransactionsList.getPostedUserTransactions = function(params, onCompletion){
        return TransactionsList.customVerb('getPostedUserTransactions', params, onCompletion);
     };

    //For Operation 'getDisputeRequest' with service id 'getOrderDetails5288'
     TransactionsList.getDisputeRequest = function(params, onCompletion){
        return TransactionsList.customVerb('getDisputeRequest', params, onCompletion);
     };

    //For Operation 'getUserScheduledTransactions' with service id 'upcomingTransactions9129'
     TransactionsList.getUserScheduledTransactions = function(params, onCompletion){
        return TransactionsList.customVerb('getUserScheduledTransactions', params, onCompletion);
     };

    //For Operation 'getLoanSchedule' with service id 'getAccountPendingAndPostedTransactions7189'
     TransactionsList.getLoanSchedule = function(params, onCompletion){
        return TransactionsList.customVerb('getLoanSchedule', params, onCompletion);
     };

    //For Operation 'createDisputeRequest' with service id 'createOrder7224'
     TransactionsList.createDisputeRequest = function(params, onCompletion){
        return TransactionsList.customVerb('createDisputeRequest', params, onCompletion);
     };

    //For Operation 'getAllTransactionsForAdmin' with service id 'getAllTransactionsForAdmin7089'
     TransactionsList.getAllTransactionsForAdmin = function(params, onCompletion){
        return TransactionsList.customVerb('getAllTransactionsForAdmin', params, onCompletion);
     };

    //For Operation 'getRecent' with service id 'getAccountPendingAndPostedTransactions8864'
     TransactionsList.getRecent = function(params, onCompletion){
        return TransactionsList.customVerb('getRecent', params, onCompletion);
     };

    //For Operation 'getPendingUserTransactions' with service id 'searchPendingUserTransactions2123'
     TransactionsList.getPendingUserTransactions = function(params, onCompletion){
        return TransactionsList.customVerb('getPendingUserTransactions', params, onCompletion);
     };

    var relations = [];

    TransactionsList.relations = relations;

    TransactionsList.prototype.isValid = function() {
        return TransactionsList.isValid(this);
    };

    TransactionsList.prototype.objModelName = "TransactionsList";
    TransactionsList.prototype.objServiceName = "Holdings";
     ...
     */
    TransactionsList.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("Holdings", "TransactionsList", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    TransactionsList.clone = function(objectToClone) {
        var clonedObj = new TransactionsList();
