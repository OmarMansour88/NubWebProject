...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "NUBChequeDetails", "objectService" : "NUBChequeManagement"};
    ...
    var setterFunctions = {
        ...
        dateStatus: function(val, state) {
            context["field"] = "dateStatus";
            context["metadata"] = (objectMetadata ? objectMetadata["dateStatus"] : null);
            state['dateStatus'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
    ...
    function NUBChequeDetails(defaultValues) {
        var privateState = {};
        context["field"] = "accountID";
        context["metadata"] = (objectMetadata ? objectMetadata["accountID"] : null);
        ...
        context["field"] = "dateStatus";
        context["metadata"] = (objectMetadata ? objectMetadata["dateStatus"] : null);
        privateState.dateStatus = defaultValues ?
            (defaultValues["dateStatus"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["dateStatus"], context) :
                null) :
            null;
        ...
        Object.defineProperties(this, {
            ...
            "dateStatus": {
                get: function() {
                    context["field"] = "dateStatus";
                    context["metadata"] = (objectMetadata ? objectMetadata["dateStatus"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.dateStatus, context);
                },
                set: function(val) {
                    setterFunctions['dateStatus'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "fileType": {
        ...
        this.fromJsonInternal = function(value) {
            ...
            privateState.dateStatus = value ? (value["dateStatus"] ? value["dateStatus"] : null) : null;
    ...
    BaseModel.isParentOf(NUBChequeDetails);

    //Create new class level validator object
    BaseModel.Validator.call(NUBChequeDetails);

    var registerValidatorBackup = NUBChequeDetails.registerValidator;

    NUBChequeDetails.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(NUBChequeDetails.isValid(this, propName, val)) {
    ...
    //For Operation 'NUBgetDetails' with service id 'NUBgetChequeSupplements4753'
     NUBChequeDetails.NUBgetDetails = function(params, onCompletion){
        return NUBChequeDetails.customVerb('NUBgetDetails', params, onCompletion);
     };

    var relations = [];

    NUBChequeDetails.relations = relations;

    NUBChequeDetails.prototype.isValid = function() {
        return NUBChequeDetails.isValid(this);
    };

    NUBChequeDetails.prototype.objModelName = "NUBChequeDetails";
    NUBChequeDetails.prototype.objServiceName = "NUBChequeManagement";
     ...
     */
    NUBChequeDetails.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("NUBChequeManagement", "NUBChequeDetails", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    NUBChequeDetails.clone = function(objectToClone) {
        var clonedObj = new NUBChequeDetails();
        clonedObj.fromJsonInternal(objectToClone.toJsonInternal());
        return clonedObj;
    };

    return NUBChequeDetails;
});