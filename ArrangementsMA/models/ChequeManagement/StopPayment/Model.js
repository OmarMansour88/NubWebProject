...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "StopPayment", "objectService" : "ChequeManagement"};
    ...
    function StopPayment(defaultValues) {
        var privateState = {};
        context["field"] = "accountID";
        context["metadata"] = (objectMetadata ? objectMetadata["accountID"] : null);
    ...
    BaseModel.isParentOf(StopPayment);

    //Create new class level validator object
    BaseModel.Validator.call(StopPayment);

    var registerValidatorBackup = StopPayment.registerValidator;

    StopPayment.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(StopPayment.isValid(this, propName, val)) {
    ...
    //For Operation 'createRequest' with service id 'CreateStopPaymentRequest7270'
     StopPayment.createRequest = function(params, onCompletion){
        return StopPayment.customVerb('createRequest', params, onCompletion);
     };

    //For Operation 'getRequest' with service id 'getStopChequeRequests8912'
     StopPayment.getRequest = function(params, onCompletion){
        return StopPayment.customVerb('getRequest', params, onCompletion);
     };

    var relations = [];

    StopPayment.relations = relations;

    StopPayment.prototype.isValid = function() {
        return StopPayment.isValid(this);
    };

    StopPayment.prototype.objModelName = "StopPayment";
    StopPayment.prototype.objServiceName = "ChequeManagement";
     ...
     */
    StopPayment.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("ChequeManagement", "StopPayment", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    StopPayment.clone = function(objectToClone) {
        var clonedObj = new StopPayment();
