...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "ChequeDetails", "objectService" : "ChequeManagement"};
    ...
    function ChequeDetails(defaultValues) {
        var privateState = {};
        context["field"] = "accountID";
        context["metadata"] = (objectMetadata ? objectMetadata["accountID"] : null);
    ...
    BaseModel.isParentOf(ChequeDetails);

    //Create new class level validator object
    BaseModel.Validator.call(ChequeDetails);

    var registerValidatorBackup = ChequeDetails.registerValidator;

    ChequeDetails.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(ChequeDetails.isValid(this, propName, val)) {
    ...
    //For Operation 'getDetails' with service id 'getChequeSupplements6401'
     ChequeDetails.getDetails = function(params, onCompletion){
        return ChequeDetails.customVerb('getDetails', params, onCompletion);
     };

    var relations = [];

    ChequeDetails.relations = relations;

    ChequeDetails.prototype.isValid = function() {
        return ChequeDetails.isValid(this);
    };

    ChequeDetails.prototype.objModelName = "ChequeDetails";
    ChequeDetails.prototype.objServiceName = "ChequeManagement";
     ...
     */
    ChequeDetails.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("ChequeManagement", "ChequeDetails", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    ChequeDetails.clone = function(objectToClone) {
        var clonedObj = new ChequeDetails();
