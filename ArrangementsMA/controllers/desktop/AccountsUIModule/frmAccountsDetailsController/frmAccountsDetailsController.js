...
define(['CommonUtilities', 'ViewConstants', 'FormControllerUtility', 'OLBConstants', 'CampaignUtility'], function(CommonUtilities, ViewConstants, FormControllerUtility, OLBConstants, CampaignUtility) {
    ...
    return {
        ...
        preshowFrmAccountDetails: function() {
            // this.view.transactions.calDateFrom.clear();
            // this.view.transactions.calDateTo.clear();
...
//             };
        ...
        AdjustScreen: function() {
            ...
            if (mainheight < screenheight) {
                ...
                this.view.flxFooter.top = (mainheight - 20) + ViewConstants.POSITIONAL_VALUES.DP;
            }
        ...
        getQuickActions: function(dataInput) {
            ...
            var quickActions = [{
                ...
                action: function(account) {
                    var savingsPotModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule({"moduleName" : "SavingsPotUIModule", "appName" : "SavingsPotMA"});
        ...
        updatePrimaryActions: function(account, scopeObj) {
            ...
            if (account.accountType === "CreditCard") {
              ...
              var param = [{
                ...
                "visibility": (configManager.checkUserFeature("UNIFIED_TRANSFER") && configManager.checkUserPermission("UNIFIED_TRANSFER_CREATE")) ? applicationManager.getConfigurationManager().isMicroAppPresent("UnifiedTransferMA") : applicationManager.getConfigurationManager().isMicroAppPresent("RegionalTransferMA")
              }, {
                "linkText": "Pay Money",
                "linkCTA": {
                  "level": "Form",
                ...
                "visibility": (configManager.checkUserFeature("UNIFIED_TRANSFER") && configManager.checkUserPermission("UNIFIED_TRANSFER_CREATE")) ? false : applicationManager.getConfigurationManager().isMicroAppPresent("RegionalTransferMA")
              }];
            } else{
                var param = [{
                    "linkText": "Transfer Money",
        ...
        actionTransferMoney: function() {
            //Function call to  open tranfers page with parameter - account obj to be tranferred from.
            if (applicationManager.getConfigurationManager().getDeploymentGeography() == "EUROPE") {
                if(applicationManager.getConfigurationManager().checkUserFeature("UNIFIED_TRANSFER") && applicationManager.getConfigurationManager().checkUserPermission("UNIFIED_TRANSFER_CREATE")){
                        var data = applicationManager.getUserPreferencesManager().getUserObj();
                        var navMan=applicationManager.getNavigationManager();
                        navMan.navigateTo({"appName": "UnifiedTransferMA","friendlyName": "frmUTFLanding"}, false, data);
                }else{
                    applicationManager.getModulesPresentationController({"appName" : "RegionalTransferMA", "moduleName" : "TransferEurUIModule"}).showTransferScreen({
        ...
        actionUpdateAccountSettings: function() {
            var profileModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule({"moduleName":"ManageArrangementsUIModule","appName":"ManageArrangementsMA"});
            profileModule.presentationController.enterProfileSettings("accountSettings");
        },
        /**
            ...
            accounts.forEach(function(account) {
                ...
                if (finalData.hasOwnProperty(accountType) && account.Membership_id === finalData[accountType][0]["membershipId"]) {
                    ...
                    finalData[accountType] = [{
                            ...
                            flxTransfersFromListHeader: {"isVisible": false},
                            lblSeparator: {
                                "isVisible": "true"
                            },
                            imgDropDown: "P",
          ...
          checkDownloadStatusOfCombinedStatementSucCallback: function(res){
            ...
            if(res.status!==undefined && res.fileId!==undefined && res.fileName!==undefined){
              ...
              if(res.status==="Success"){
                 this.view.viewStatementsnew.lblInfoMessage.text=kony.i18n.getLocalizedString("i18n.olb.ViewStatementInfo");
