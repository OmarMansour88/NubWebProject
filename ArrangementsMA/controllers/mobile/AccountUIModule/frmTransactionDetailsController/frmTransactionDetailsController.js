define({
  ...
  onNavigate: function(obj) {
    ...
    this.view.accountsTransactionDetailsNative.navigateToViewAttachments = function(attachments)
    {
      ...
      accMod.presentationController.commonFunctionForNavigation("AccountUIModule/frmShowAttachments");
    };
  },
  preShow:function()
  {
...
//       }
  ...
  btnReferenceValueOnClick: function() {
        ...
        var ModulePresentationController = applicationManager.getModulesPresentationController("AccountUIModule");
