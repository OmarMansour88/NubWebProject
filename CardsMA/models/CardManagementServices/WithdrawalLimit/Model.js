...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "WithdrawalLimit", "objectService" : "CardManagementServices"};
    ...
    function WithdrawalLimit(defaultValues) {
        var privateState = {};
        context["field"] = "accountId";
        context["metadata"] = (objectMetadata ? objectMetadata["accountId"] : null);
    ...
    BaseModel.isParentOf(WithdrawalLimit);

    //Create new class level validator object
    BaseModel.Validator.call(WithdrawalLimit);

    var registerValidatorBackup = WithdrawalLimit.registerValidator;

    WithdrawalLimit.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(WithdrawalLimit.isValid(this, propName, val)) {
    ...
    //For Operation 'updateLimit' with service id 'createOrder7880'
     WithdrawalLimit.updateLimit = function(params, onCompletion){
        return WithdrawalLimit.customVerb('updateLimit', params, onCompletion);
     };

    var relations = [];

    WithdrawalLimit.relations = relations;

    WithdrawalLimit.prototype.isValid = function() {
        return WithdrawalLimit.isValid(this);
    };

    WithdrawalLimit.prototype.objModelName = "WithdrawalLimit";
     ...
     */
    WithdrawalLimit.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("CardManagementServices", "WithdrawalLimit", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    WithdrawalLimit.clone = function(objectToClone) {
        var clonedObj = new WithdrawalLimit();
