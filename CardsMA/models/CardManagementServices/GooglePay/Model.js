...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "GooglePay", "objectService" : "CardManagementServices"};
    ...
    function GooglePay(defaultValues) {
        var privateState = {};
        context["field"] = "errmsg";
        context["metadata"] = (objectMetadata ? objectMetadata["errmsg"] : null);
    ...
    BaseModel.isParentOf(GooglePay);

    //Create new class level validator object
    BaseModel.Validator.call(GooglePay);

    var registerValidatorBackup = GooglePay.registerValidator;

    GooglePay.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(GooglePay.isValid(this, propName, val)) {
    ...
    //For Operation 'AddCard' with service id 'universalCardEnrollment4038'
     GooglePay.AddCard = function(params, onCompletion){
        return GooglePay.customVerb('AddCard', params, onCompletion);
     };

    var relations = [];

    GooglePay.relations = relations;

    GooglePay.prototype.isValid = function() {
        return GooglePay.isValid(this);
    };

    GooglePay.prototype.objModelName = "GooglePay";
     ...
     */
    GooglePay.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("CardManagementServices", "GooglePay", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    GooglePay.clone = function(objectToClone) {
        var clonedObj = new GooglePay();
