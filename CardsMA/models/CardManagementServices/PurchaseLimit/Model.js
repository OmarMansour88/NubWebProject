...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "PurchaseLimit", "objectService" : "CardManagementServices"};
    ...
    function PurchaseLimit(defaultValues) {
        var privateState = {};
        context["field"] = "accountId";
        context["metadata"] = (objectMetadata ? objectMetadata["accountId"] : null);
    ...
    BaseModel.isParentOf(PurchaseLimit);

    //Create new class level validator object
    BaseModel.Validator.call(PurchaseLimit);

    var registerValidatorBackup = PurchaseLimit.registerValidator;

    PurchaseLimit.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(PurchaseLimit.isValid(this, propName, val)) {
    ...
    //For Operation 'updateLimit' with service id 'createOrder2168'
     PurchaseLimit.updateLimit = function(params, onCompletion){
        return PurchaseLimit.customVerb('updateLimit', params, onCompletion);
     };

    var relations = [];

    PurchaseLimit.relations = relations;

    PurchaseLimit.prototype.isValid = function() {
        return PurchaseLimit.isValid(this);
    };

    PurchaseLimit.prototype.objModelName = "PurchaseLimit";
     ...
     */
    PurchaseLimit.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("CardManagementServices", "PurchaseLimit", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    PurchaseLimit.clone = function(objectToClone) {
        var clonedObj = new PurchaseLimit();
