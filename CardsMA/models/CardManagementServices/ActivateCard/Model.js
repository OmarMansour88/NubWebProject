...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "ActivateCard", "objectService" : "CardManagementServices"};
    ...
    function ActivateCard(defaultValues) {
        var privateState = {};
        context["field"] = "accountId";
        context["metadata"] = (objectMetadata ? objectMetadata["accountId"] : null);
    ...
    BaseModel.isParentOf(ActivateCard);

    //Create new class level validator object
    BaseModel.Validator.call(ActivateCard);

    var registerValidatorBackup = ActivateCard.registerValidator;

    ActivateCard.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(ActivateCard.isValid(this, propName, val)) {
    ...
    //For Operation 'createRequest' with service id 'createOrder6315'
     ActivateCard.createRequest = function(params, onCompletion){
        return ActivateCard.customVerb('createRequest', params, onCompletion);
     };

    var relations = [];

    ActivateCard.relations = relations;

    ActivateCard.prototype.isValid = function() {
        return ActivateCard.isValid(this);
    };

    ActivateCard.prototype.objModelName = "ActivateCard";
     ...
     */
    ActivateCard.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("CardManagementServices", "ActivateCard", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    ActivateCard.clone = function(objectToClone) {
        var clonedObj = new ActivateCard();
