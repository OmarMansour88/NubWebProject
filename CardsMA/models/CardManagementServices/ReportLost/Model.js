...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "ReportLost", "objectService" : "CardManagementServices"};
    ...
    function ReportLost(defaultValues) {
        var privateState = {};
        context["field"] = "accountId";
        context["metadata"] = (objectMetadata ? objectMetadata["accountId"] : null);
    ...
    BaseModel.isParentOf(ReportLost);

    //Create new class level validator object
    BaseModel.Validator.call(ReportLost);

    var registerValidatorBackup = ReportLost.registerValidator;

    ReportLost.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(ReportLost.isValid(this, propName, val)) {
    ...
    //For Operation 'createRequest' with service id 'createOrder1364'
     ReportLost.createRequest = function(params, onCompletion){
        return ReportLost.customVerb('createRequest', params, onCompletion);
     };

    var relations = [];

    ReportLost.relations = relations;

    ReportLost.prototype.isValid = function() {
        return ReportLost.isValid(this);
    };

    ReportLost.prototype.objModelName = "ReportLost";
     ...
     */
    ReportLost.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("CardManagementServices", "ReportLost", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    ReportLost.clone = function(objectToClone) {
        var clonedObj = new ReportLost();
