...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "CardIssuer", "objectService" : "CardManagementServices"};
    ...
    function CardIssuer(defaultValues) {
        var privateState = {};
        context["field"] = "cardHolderName";
        context["metadata"] = (objectMetadata ? objectMetadata["cardHolderName"] : null);
    ...
    BaseModel.isParentOf(CardIssuer);

    //Create new class level validator object
    BaseModel.Validator.call(CardIssuer);

    var registerValidatorBackup = CardIssuer.registerValidator;

    CardIssuer.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(CardIssuer.isValid(this, propName, val)) {
    ...
    //For Operation 'EnrollWithIssuer' with service id 'enrollCard7689'
     CardIssuer.EnrollWithIssuer = function(params, onCompletion){
        return CardIssuer.customVerb('EnrollWithIssuer', params, onCompletion);
     };

    var relations = [];

    CardIssuer.relations = relations;

    CardIssuer.prototype.isValid = function() {
        return CardIssuer.isValid(this);
    };

    CardIssuer.prototype.objModelName = "CardIssuer";
     ...
     */
    CardIssuer.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("CardManagementServices", "CardIssuer", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    CardIssuer.clone = function(objectToClone) {
        var clonedObj = new CardIssuer();
