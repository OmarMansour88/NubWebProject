...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "UnlockCard", "objectService" : "CardManagementServices"};
    ...
    function UnlockCard(defaultValues) {
        var privateState = {};
        context["field"] = "accountId";
        context["metadata"] = (objectMetadata ? objectMetadata["accountId"] : null);
    ...
    BaseModel.isParentOf(UnlockCard);

    //Create new class level validator object
    BaseModel.Validator.call(UnlockCard);

    var registerValidatorBackup = UnlockCard.registerValidator;

    UnlockCard.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(UnlockCard.isValid(this, propName, val)) {
    ...
    //For Operation 'createRequest' with service id 'createOrder8365'
     UnlockCard.createRequest = function(params, onCompletion){
        return UnlockCard.customVerb('createRequest', params, onCompletion);
     };

    var relations = [];

    UnlockCard.relations = relations;

    UnlockCard.prototype.isValid = function() {
        return UnlockCard.isValid(this);
    };

    UnlockCard.prototype.objModelName = "UnlockCard";
     ...
     */
    UnlockCard.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("CardManagementServices", "UnlockCard", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    UnlockCard.clone = function(objectToClone) {
        var clonedObj = new UnlockCard();
