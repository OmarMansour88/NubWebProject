...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "ReplaceCard", "objectService" : "CardManagementServices"};
    ...
    function ReplaceCard(defaultValues) {
        var privateState = {};
        context["field"] = "accountId";
        context["metadata"] = (objectMetadata ? objectMetadata["accountId"] : null);
    ...
    BaseModel.isParentOf(ReplaceCard);

    //Create new class level validator object
    BaseModel.Validator.call(ReplaceCard);

    var registerValidatorBackup = ReplaceCard.registerValidator;

    ReplaceCard.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(ReplaceCard.isValid(this, propName, val)) {
    ...
    //For Operation 'createRequest' with service id 'createOrder7268'
     ReplaceCard.createRequest = function(params, onCompletion){
        return ReplaceCard.customVerb('createRequest', params, onCompletion);
     };

    var relations = [];

    ReplaceCard.relations = relations;

    ReplaceCard.prototype.isValid = function() {
        return ReplaceCard.isValid(this);
    };

    ReplaceCard.prototype.objModelName = "ReplaceCard";
     ...
     */
    ReplaceCard.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("CardManagementServices", "ReplaceCard", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    ReplaceCard.clone = function(objectToClone) {
        var clonedObj = new ReplaceCard();
