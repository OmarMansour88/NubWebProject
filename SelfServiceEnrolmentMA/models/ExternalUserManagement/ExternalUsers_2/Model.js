...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "ExternalUsers_2", "objectService" : "ExternalUserManagement"};
    ...
    var setterFunctions = {
        ...
        keys: function(val, state) {
            context["field"] = "keys";
            context["metadata"] = (objectMetadata ? objectMetadata["keys"] : null);
            state['keys'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
    };

    //Create the Model Class
    function ExternalUsers_2(defaultValues) {
        var privateState = {};
        context["field"] = "id";
        context["metadata"] = (objectMetadata ? objectMetadata["id"] : null);
        ...
        context["field"] = "keys";
        context["metadata"] = (objectMetadata ? objectMetadata["keys"] : null);
        privateState.keys = defaultValues ?
            (defaultValues["keys"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["keys"], context) :
                null) :
            null;
        ...
        Object.defineProperties(this, {
            ...
            "keys": {
                get: function() {
                    context["field"] = "keys";
                    context["metadata"] = (objectMetadata ? objectMetadata["keys"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.keys, context);
                },
                set: function(val) {
                    setterFunctions['keys'].call(this, val, privateState);
                },
                enumerable: true,
            },
        });
        ...
        this.fromJsonInternal = function(value) {
            ...
            privateState.keys = value ? (value["keys"] ? value["keys"] : null) : null;
        };
    }

    //Setting BaseModel as Parent to this Model
    BaseModel.isParentOf(ExternalUsers_2);

    //Create new class level validator object
    BaseModel.Validator.call(ExternalUsers_2);

    var registerValidatorBackup = ExternalUsers_2.registerValidator;

    ExternalUsers_2.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(ExternalUsers_2.isValid(this, propName, val)) {
    ...
    //For Operation 'verifyDbxUserName' with service id 'verifyDbxUserName9757'
     ExternalUsers_2.verifyDbxUserName = function(params, onCompletion){
        return ExternalUsers_2.customVerb('verifyDbxUserName', params, onCompletion);
     };

    //For Operation 'getUserNameAndPasswordRulesAndPolicies' with service id 'getUserNameAndPasswordRulesAndPolicies9819'
     ExternalUsers_2.getUserNameAndPasswordRulesAndPolicies = function(params, onCompletion){
        return ExternalUsers_2.customVerb('getUserNameAndPasswordRulesAndPolicies', params, onCompletion);
     };

    //For Operation 'getCustomerTypes' with service id 'getCustomerTypes3510'
     ExternalUsers_2.getCustomerTypes = function(params, onCompletion){
        return ExternalUsers_2.customVerb('getCustomerTypes', params, onCompletion);
     };

    //For Operation 'getPasswordPolicy' with service id 'getPasswordPolicy1010'
     ExternalUsers_2.getPasswordPolicy = function(params, onCompletion){
        return ExternalUsers_2.customVerb('getPasswordPolicy', params, onCompletion);
     };

    //For Operation 'getCustomerCommunication' with service id 'getCustomerCommunication7155'
     ExternalUsers_2.getCustomerCommunication = function(params, onCompletion){
        return ExternalUsers_2.customVerb('getCustomerCommunication', params, onCompletion);
     };

    //For Operation 'getUserNameAndPasswordPolicies' with service id 'getUserNameAndPasswordPolicies2751'
     ExternalUsers_2.getUserNameAndPasswordPolicies = function(params, onCompletion){
        return ExternalUsers_2.customVerb('getUserNameAndPasswordPolicies', params, onCompletion);
     };

    //For Operation 'createTaxDetails' with service id 'CreateTaxOperation9137'
     ExternalUsers_2.createTaxDetails = function(params, onCompletion){
        return ExternalUsers_2.customVerb('createTaxDetails', params, onCompletion);
     };

    //For Operation 'updateTaxDetails' with service id 'UpdateTaxOperation8244'
     ExternalUsers_2.updateTaxDetails = function(params, onCompletion){
        return ExternalUsers_2.customVerb('updateTaxDetails', params, onCompletion);
     };

    //For Operation 'requestUpdateSecurityQuestionsOTP' with service id 'RequestOTPPreLogin1111'
     ExternalUsers_2.requestUpdateSecurityQuestionsOTP = function(params, onCompletion){
        return ExternalUsers_2.customVerb('requestUpdateSecurityQuestionsOTP', params, onCompletion);
     };

    //For Operation 'GetDueDiligenceDetails' with service id 'GetDueDiligenceOperation3137'
     ExternalUsers_2.GetDueDiligenceDetails = function(params, onCompletion){
        return ExternalUsers_2.customVerb('GetDueDiligenceDetails', params, onCompletion);
     };

    //For Operation 'updateDBXUserName' with service id 'updateDBXUserName8059'
     ExternalUsers_2.updateDBXUserName = function(params, onCompletion){
        return ExternalUsers_2.customVerb('updateDBXUserName', params, onCompletion);
     };

    //For Operation 'updateUserStatus' with service id 'UpdateDBXUserStatus7858'
     ExternalUsers_2.updateUserStatus = function(params, onCompletion){
        return ExternalUsers_2.customVerb('updateUserStatus', params, onCompletion);
     };

    //For Operation 'dbxRequestOTP' with service id 'dbxrequestOTP9356'
     ExternalUsers_2.dbxRequestOTP = function(params, onCompletion){
        return ExternalUsers_2.customVerb('dbxRequestOTP', params, onCompletion);
     };

    //For Operation 'getGroups' with service id 'getGroups6746'
     ExternalUsers_2.getGroups = function(params, onCompletion){
        return ExternalUsers_2.customVerb('getGroups', params, onCompletion);
     };

    //For Operation 'getUserNameAndPasswordRules' with service id 'getUsernameAndPasswordRules2133'
     ExternalUsers_2.getUserNameAndPasswordRules = function(params, onCompletion){
        return ExternalUsers_2.customVerb('getUserNameAndPasswordRules', params, onCompletion);
     };

    //For Operation 'UpdatePasswordForActivationFlow' with service id 'UpdatePasswordForActivationFlowOperation3204'
     ExternalUsers_2.UpdatePasswordForActivationFlow = function(params, onCompletion){
        return ExternalUsers_2.customVerb('UpdatePasswordForActivationFlow', params, onCompletion);
     };

    //For Operation 'createGroup' with service id 'createGroup8217'
     ExternalUsers_2.createGroup = function(params, onCompletion){
        return ExternalUsers_2.customVerb('createGroup', params, onCompletion);
     };

    //For Operation 'regenerateActivationCode' with service id 'regenerateActivationCode8772'
     ExternalUsers_2.regenerateActivationCode = function(params, onCompletion){
        return ExternalUsers_2.customVerb('regenerateActivationCode', params, onCompletion);
     };

    //For Operation 'UpdateEmploymentDetails' with service id 'UpdateEmploymentOperation7523'
     ExternalUsers_2.UpdateEmploymentDetails = function(params, onCompletion){
        return ExternalUsers_2.customVerb('UpdateEmploymentDetails', params, onCompletion);
     };

    //For Operation 'getUserNamePolicy' with service id 'getUsernamePolicy7844'
     ExternalUsers_2.getUserNamePolicy = function(params, onCompletion){
        return ExternalUsers_2.customVerb('getUserNamePolicy', params, onCompletion);
     };

    //For Operation 'resetUserPasswordFromEmail' with service id 'ResetUserPasswordFromEmail1681'
     ExternalUsers_2.resetUserPasswordFromEmail = function(params, onCompletion){
        return ExternalUsers_2.customVerb('resetUserPasswordFromEmail', params, onCompletion);
     };

    //For Operation 'requestPreLoginOTP' with service id 'RequestOTPPreLogin4998'
     ExternalUsers_2.requestPreLoginOTP = function(params, onCompletion){
        return ExternalUsers_2.customVerb('requestPreLoginOTP', params, onCompletion);
     };

    //For Operation 'getUserNameRules' with service id 'getUserNameRules4796'
     ExternalUsers_2.getUserNameRules = function(params, onCompletion){
        return ExternalUsers_2.customVerb('getUserNameRules', params, onCompletion);
     };

    //For Operation 'getDbxUserStatus' with service id 'GetDBXUserStatus1869'
     ExternalUsers_2.getDbxUserStatus = function(params, onCompletion){
        return ExternalUsers_2.customVerb('getDbxUserStatus', params, onCompletion);
     };

    //For Operation 'updateUserPassword' with service id 'updateDBXUserPassword9683'
     ExternalUsers_2.updateUserPassword = function(params, onCompletion){
        return ExternalUsers_2.customVerb('updateUserPassword', params, onCompletion);
     };

    //For Operation 'verifyMFAOTP' with service id 'verifyMFAOTP1187'
     ExternalUsers_2.verifyMFAOTP = function(params, onCompletion){
        return ExternalUsers_2.customVerb('verifyMFAOTP', params, onCompletion);
     };

    //For Operation 'fetchAuthorizedSignatories' with service id 'SearchAuthorizedSignatoriesByMembership8662'
     ExternalUsers_2.fetchAuthorizedSignatories = function(params, onCompletion){
        return ExternalUsers_2.customVerb('fetchAuthorizedSignatories', params, onCompletion);
     };

    //For Operation 'getEAgreementPdfDownloaded' with service id 'GetEAgreementPdfDownloaded1446'
     ExternalUsers_2.getEAgreementPdfDownloaded = function(params, onCompletion){
        return ExternalUsers_2.customVerb('getEAgreementPdfDownloaded', params, onCompletion);
     };

    //For Operation 'getAddressTypes' with service id 'getAddressTypesOperation3937'
     ExternalUsers_2.getAddressTypes = function(params, onCompletion){
        return ExternalUsers_2.customVerb('getAddressTypes', params, onCompletion);
     };

    //For Operation 'verifyOTPPreLoginEnroll' with service id 'VerifyOTPPreLoginEnroll5460'
     ExternalUsers_2.verifyOTPPreLoginEnroll = function(params, onCompletion){
        return ExternalUsers_2.customVerb('verifyOTPPreLoginEnroll', params, onCompletion);
     };

    //For Operation 'IsEmailLinkActive' with service id 'IsEmailLinkActive2056'
     ExternalUsers_2.IsEmailLinkActive = function(params, onCompletion){
        return ExternalUsers_2.customVerb('IsEmailLinkActive', params, onCompletion);
     };

    //For Operation 'requestOTPRegisterMB' with service id 'RequestPreLoginOTPMB6988'
     ExternalUsers_2.requestOTPRegisterMB = function(params, onCompletion){
        return ExternalUsers_2.customVerb('requestOTPRegisterMB', params, onCompletion);
     };

    //For Operation 'verifyOTPPreLoginMB' with service id 'VerifyPreLoginOTPMB2161'
     ExternalUsers_2.verifyOTPPreLoginMB = function(params, onCompletion){
        return ExternalUsers_2.customVerb('verifyOTPPreLoginMB', params, onCompletion);
     };

    //For Operation 'IsSharedTokenValid' with service id 'IsSharedTokenValid6415'
     ExternalUsers_2.IsSharedTokenValid = function(params, onCompletion){
        return ExternalUsers_2.customVerb('IsSharedTokenValid', params, onCompletion);
     };

    //For Operation 'ResendActivationLink' with service id 'ResendOrgEmployeeActivationLink3557'
     ExternalUsers_2.ResendActivationLink = function(params, onCompletion){
        return ExternalUsers_2.customVerb('ResendActivationLink', params, onCompletion);
     };

    //For Operation 'getCustomerDetailsInPartyAndT24' with service id 'getCustomerDetailsInPartyAndT243435'
     ExternalUsers_2.getCustomerDetailsInPartyAndT24 = function(params, onCompletion){
        return ExternalUsers_2.customVerb('getCustomerDetailsInPartyAndT24', params, onCompletion);
     };

    //For Operation 'updateUserProfileImage' with service id 'UpdateUserProfileImage6855'
     ExternalUsers_2.updateUserProfileImage = function(params, onCompletion){
        return ExternalUsers_2.customVerb('updateUserProfileImage', params, onCompletion);
     };

    //For Operation 'getAccountActionCustomerApproverList' with service id 'getAccountActionApproverList6707'
     ExternalUsers_2.getAccountActionCustomerApproverList = function(params, onCompletion){
        return ExternalUsers_2.customVerb('getAccountActionCustomerApproverList', params, onCompletion);
     };

    //For Operation 'updateCitizenship' with service id 'UpdateCitizenshipOpearation2649'
     ExternalUsers_2.updateCitizenship = function(params, onCompletion){
        return ExternalUsers_2.customVerb('updateCitizenship', params, onCompletion);
     };

    //For Operation 'updateCustomerProfile' with service id 'updateCustomerProfile6713'
     ExternalUsers_2.updateCustomerProfile = function(params, onCompletion){
        return ExternalUsers_2.customVerb('updateCustomerProfile', params, onCompletion);
     };

    //For Operation 'requestOTPPreLoginMB' with service id 'RequestPreLoginOTPMB9319'
     ExternalUsers_2.requestOTPPreLoginMB = function(params, onCompletion){
        return ExternalUsers_2.customVerb('requestOTPPreLoginMB', params, onCompletion);
     };

    //For Operation 'sendActivationCodeForEnrollment' with service id 'sendActivationCodeForEnrollment6485'
     ExternalUsers_2.sendActivationCodeForEnrollment = function(params, onCompletion){
        return ExternalUsers_2.customVerb('sendActivationCodeForEnrollment', params, onCompletion);
     };

    //For Operation 'createCustomerInPartyandT24' with service id 'createCustomerInPartyAndT245144'
     ExternalUsers_2.createCustomerInPartyandT24 = function(params, onCompletion){
        return ExternalUsers_2.customVerb('createCustomerInPartyandT24', params, onCompletion);
     };

    //For Operation 'requestMFAOTP' with service id 'RequestMFAOTP8041'
     ExternalUsers_2.requestMFAOTP = function(params, onCompletion){
        return ExternalUsers_2.customVerb('requestMFAOTP', params, onCompletion);
     };

    //For Operation 'sendDbxResetPasswordEmail' with service id 'sendDbxResetPasswordLink9649'
     ExternalUsers_2.sendDbxResetPasswordEmail = function(params, onCompletion){
        return ExternalUsers_2.customVerb('sendDbxResetPasswordEmail', params, onCompletion);
     };

    //For Operation 'validateActivationCodeForEnrollment' with service id 'ValidateEnrollmentActivationCode7539'
     ExternalUsers_2.validateActivationCodeForEnrollment = function(params, onCompletion){
        return ExternalUsers_2.customVerb('validateActivationCodeForEnrollment', params, onCompletion);
     };

    //For Operation 'GetTaxDetails' with service id 'GetTaxOperation1410'
     ExternalUsers_2.GetTaxDetails = function(params, onCompletion){
        return ExternalUsers_2.customVerb('GetTaxDetails', params, onCompletion);
     };

    //For Operation 'getMFAServiceConfig' with service id 'getMFAServiceConfig5679'
     ExternalUsers_2.getMFAServiceConfig = function(params, onCompletion){
        return ExternalUsers_2.customVerb('getMFAServiceConfig', params, onCompletion);
     };

    //For Operation 'dbxVerifyOTP' with service id 'dbxverifyOTP8700'
     ExternalUsers_2.dbxVerifyOTP = function(params, onCompletion){
        return ExternalUsers_2.customVerb('dbxVerifyOTP', params, onCompletion);
     };

    //For Operation 'updateCustomerDetailsForAdmin' with service id 'UpdateCustomerDetails9201'
     ExternalUsers_2.updateCustomerDetailsForAdmin = function(params, onCompletion){
        return ExternalUsers_2.customVerb('updateCustomerDetailsForAdmin', params, onCompletion);
     };

    //For Operation 'getBBCustomerServiceLimit' with service id 'getBBCustomerServiceLimit8755'
     ExternalUsers_2.getBBCustomerServiceLimit = function(params, onCompletion){
        return ExternalUsers_2.customVerb('getBBCustomerServiceLimit', params, onCompletion);
     };

    //For Operation 'OFACAndCIPChecks' with service id 'OFACAndCIPChecks5574'
     ExternalUsers_2.OFACAndCIPChecks = function(params, onCompletion){
        return ExternalUsers_2.customVerb('OFACAndCIPChecks', params, onCompletion);
     };

    //For Operation 'getAPIPasswordLockoutSettings' with service id 'getAPIPasswordLockoutSettings8266'
     ExternalUsers_2.getAPIPasswordLockoutSettings = function(params, onCompletion){
        return ExternalUsers_2.customVerb('getAPIPasswordLockoutSettings', params, onCompletion);
     };

    //For Operation 'GetEmploymentDetails' with service id 'GetEmploymentOperation5855'
     ExternalUsers_2.GetEmploymentDetails = function(params, onCompletion){
        return ExternalUsers_2.customVerb('GetEmploymentDetails', params, onCompletion);
     };

    //For Operation 'getUserNameRulesAndPolicy' with service id 'getUserNameRulesAndPolicy1255'
     ExternalUsers_2.getUserNameRulesAndPolicy = function(params, onCompletion){
        return ExternalUsers_2.customVerb('getUserNameRulesAndPolicy', params, onCompletion);
     };

    //For Operation 'verifyUpdateSecurityQuestionsOTP' with service id 'VerifyOTPPreLogin6144'
     ExternalUsers_2.verifyUpdateSecurityQuestionsOTP = function(params, onCompletion){
        return ExternalUsers_2.customVerb('verifyUpdateSecurityQuestionsOTP', params, onCompletion);
     };

    //For Operation 'CreateEmploymentDetails' with service id 'CreateEmploymentOperation5693'
     ExternalUsers_2.CreateEmploymentDetails = function(params, onCompletion){
        return ExternalUsers_2.customVerb('CreateEmploymentDetails', params, onCompletion);
     };

    //For Operation 'requestOTPPreLogin' with service id 'RequestNUOOtp1869'
     ExternalUsers_2.requestOTPPreLogin = function(params, onCompletion){
        return ExternalUsers_2.customVerb('requestOTPPreLogin', params, onCompletion);
     };

    //For Operation 'getPasswordRules' with service id 'getPasswordRules9416'
     ExternalUsers_2.getPasswordRules = function(params, onCompletion){
        return ExternalUsers_2.customVerb('getPasswordRules', params, onCompletion);
     };

    //For Operation 'sendCustomerUnlockEmail' with service id 'sendCustomerUnlockEmail1870'
     ExternalUsers_2.sendCustomerUnlockEmail = function(params, onCompletion){
        return ExternalUsers_2.customVerb('sendCustomerUnlockEmail', params, onCompletion);
     };

    //For Operation 'getCustomerDetails' with service id 'GetCustomerDetails2513'
     ExternalUsers_2.getCustomerDetails = function(params, onCompletion){
        return ExternalUsers_2.customVerb('getCustomerDetails', params, onCompletion);
     };

    //For Operation 'CreateDbxMicroBusinessOwner' with service id 'createMicroBusinessOwner4821'
     ExternalUsers_2.CreateDbxMicroBusinessOwner = function(params, onCompletion){
        return ExternalUsers_2.customVerb('CreateDbxMicroBusinessOwner', params, onCompletion);
     };

    //For Operation 'requestEnrollOTP' with service id 'RequestPreLoginEnrollOTP2387'
     ExternalUsers_2.requestEnrollOTP = function(params, onCompletion){
        return ExternalUsers_2.customVerb('requestEnrollOTP', params, onCompletion);
     };

    //For Operation 'deleteUserProfileImage' with service id 'DeleteUserProfileImage1304'
     ExternalUsers_2.deleteUserProfileImage = function(params, onCompletion){
        return ExternalUsers_2.customVerb('deleteUserProfileImage', params, onCompletion);
     };

    //For Operation 'downloadEAgreementPdf' with service id 'GetEAgreementPdfDownloaded2866'
     ExternalUsers_2.downloadEAgreementPdf = function(params, onCompletion){
        return ExternalUsers_2.customVerb('downloadEAgreementPdf', params, onCompletion);
     };

    //For Operation 'createBBCustomerServiceLimit' with service id 'createBBCustomerServiceLimit1793'
     ExternalUsers_2.createBBCustomerServiceLimit = function(params, onCompletion){
        return ExternalUsers_2.customVerb('createBBCustomerServiceLimit', params, onCompletion);
     };

    //For Operation 'createUser' with service id 'CreateDbxUserNew1561'
     ExternalUsers_2.createUser = function(params, onCompletion){
        return ExternalUsers_2.customVerb('createUser', params, onCompletion);
     };

    //For Operation 'editBBCustomerServiceLimit' with service id 'editBBCustomerServiceLimit8796'
     ExternalUsers_2.editBBCustomerServiceLimit = function(params, onCompletion){
        return ExternalUsers_2.customVerb('editBBCustomerServiceLimit', params, onCompletion);
     };

    //For Operation 'updateCustomerInPartyAndT24' with service id 'updateCustomerInPartyAndT244165'
     ExternalUsers_2.updateCustomerInPartyAndT24 = function(params, onCompletion){
        return ExternalUsers_2.customVerb('updateCustomerInPartyAndT24', params, onCompletion);
     };

    var relations = [];

    ExternalUsers_2.relations = relations;

    ExternalUsers_2.prototype.isValid = function() {
        return ExternalUsers_2.isValid(this);
    };

    ExternalUsers_2.prototype.objModelName = "ExternalUsers_2";
     ...
     */
    ExternalUsers_2.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("ExternalUserManagement", "ExternalUsers_2", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    ExternalUsers_2.clone = function(objectToClone) {
        var clonedObj = new ExternalUsers_2();
        clonedObj.fromJsonInternal(objectToClone.toJsonInternal());
        return clonedObj;
    };

    return ExternalUsers_2;
});