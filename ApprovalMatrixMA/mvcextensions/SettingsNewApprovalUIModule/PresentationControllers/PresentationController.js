...
//         }
     ...
     */
    SettingsNew_PresentationController.prototype.showConsentManagement = function() {
        applicationManager.getNavigationManager().updateForm({
            isLoading: true
     ...
     * Method used to fetch the profile
     */
    SettingsNew_PresentationController.prototype.showConsentManagementSuccess = function(response) {
     ...
     * Method used to fetch the profile
     */
    SettingsNew_PresentationController.prototype.showConsentManagementFailure = function(response) {
        //CommonUtilities.showServerDownScreen();
        applicationManager.getNavigationManager().navigateTo('frmConsentManagement');
        applicationManager.getNavigationManager().updateForm({
  ...
  * @param {String} AlertId - ID of the Alert
  ...
  SettingsNew_PresentationController.prototype.getAllSignatoryGroupsbyCoreCustomerIds = function() {
        ...
        var data = {
         ...
         applicationManager.getSettingsApprovalManager().getAllSignatoryGroupsbyCoreCustomerIds(corecutomer, this.getAllSignatoryGroupsbyCoreCustomerIdsSuccess.bind(this), this.getAllSignatoryGroupsbyCoreCustomerIdsFailure.bind(this));
    };
  ...
  SettingsNew_PresentationController.prototype.fetchAccountsListFailure = function(cif,data){
    this.presenter = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule({ appName: "HomepageMA",moduleName: "AccountsUIModule"});
...
SettingsNew_PresentationController.prototype.sortSegmentDataforAccountLevel = function(segmentData, sectionIndex, imgWidget, sortKey){
  ...
  SettingsNew_PresentationController.prototype.getAllSignatoryGroups = function(data,response) {
        ...
        applicationManager.getSettingsApprovalManager().getAllSignatoryGroups(input, this.getAllSignatoryGroupsSuccess.bind(this,response), this.getAllSignatoryGroupsFailue.bind(this,response));
    };
  ...
  SettingsNew_PresentationController.prototype.getSignatoryGroupDetails = function(signatoryId) {
		...
		applicationManager.getSettingsApprovalManager().getSignatoryGroupDetails(input,this.getSignatoryGroupDetailsSuccess.bind(this),this.getSignatoryGroupDetailsFailue.bind(this) );
	...
	SettingsNew_PresentationController.prototype.getSignatoryGroupDetailsSuccess = function (response){
        ...
        response.signatories.forEach(function(user) {
			user.createdts = CommonUtilities.getFrontendDateStringInUTC(user.addedts, "mm/dd/yyyy");
		});
		applicationManager.getNavigationManager().updateForm({
      ...
      for (var action = 0; action < actions.length; action++) {
        if (kony.sdk.isNullOrUndefined(processedData[actions[action].actionId])) {
          processedData[actions[action].actionId] = {
            ...
            "isAccountLevel": actions[action]["isAccountLevel"],
   ...
   */
  /*SettingsNew_PresentationController.prototype.editConsentManagement = function(Context) {
      this.showProgressBar();
     ...
     * @param {Object} context - contains the consentBlock, consentType, consentGiven, blockNotes, consentTypeName.
     */
    SettingsNew_PresentationController.prototype.editConsentManagement = function(consentDetails) {
        this.showProgressBar();
     ...
     */
     SettingsNew_PresentationController.prototype.editConsentManagementSuccess = function(response) {
     ...
     * @param {String} errorMessage - contains the error message for edit service.
     */
    SettingsNew_PresentationController.prototype.editConsentManagementFailure = function(response) {
        applicationManager.getNavigationManager().navigateTo('frmConsentManagement');
        applicationManager.getNavigationManager().updateForm({
            "consentError": response.errorMessage,
            "action": "update"
   ...
   * @param {String} errorMessage - contains the error message for edit service.
   */
  /*SettingsNew_PresentationController.prototype.editConsenManagementFailure = function(errorMessage) {
      var viewProperties = {
          isLoading: false,
  ...
  */
   SettingsNew_PresentationController.prototype.showManageAccountAccess = function() {
    applicationManager.getNavigationManager().updateForm({
        "isLoading": true
...
SettingsNew_PresentationController.prototype.showManageAccountAccessSuccess = function(response) {
...
SettingsNew_PresentationController.prototype.showManageAccountAccessFailure = function(response) {
// CommonUtilities.showServerDownScreen();
applicationManager.getNavigationManager().navigateTo('frmManageAccountAccess');
applicationManager.getNavigationManager().updateForm({
...
*/
SettingsNew_PresentationController.prototype.updateRevokeAccountAccess = function(accountData) {
this.showProgressBar();
var mfaManager = applicationManager.getMFAManager();
...
*/
SettingsNew_PresentationController.prototype.updateRevokeAccountAccessSuccess = function(response) {
var mfaManager = applicationManager.getMFAManager();
if (response && response.MFAAttributes) {
  if (response.MFAAttributes.isMFARequired == "true") {
    var mfaJSON = {
...
* @param {String} errorMessage - contains the error message for edit service.
*/
SettingsNew_PresentationController.prototype.updateRevokeAccountAccessFailure = function(response) {
 ...
 SettingsNew_PresentationController.prototype.getTermsandConditionsSuccessCallBack = function(type,response){
  ...
  SettingsNew_PresentationController.prototype.disableEBankingAccess = function(){
   ...
   /**
    ...
    SettingsNew_PresentationController.prototype.updateSignatoryGroupdetails = function(context) {
      applicationManager.getSettingsApprovalManager().updateSignatoryGroup(context, this.updateSignatorySuccess.bind(this), this.updateSignatoryFailure.bind(this));
    };
    /**
     * Method to update the Signatory group
     * @param {Object} response - contains the response from the service.
    ...
    SettingsNew_PresentationController.prototype.updateSignatoryFailure = function(response) {
      ...
      applicationManager.getSettingsApprovalManager().updateSignatoryGroup(context, this.updateSignatoryGroupdetailsFromAddUsersSuccess.bind(this), this.updateSignatoryGroupdetailsFromAddUsersFailure.bind(this));
    };
    /**
     * Method to update the Signatory group
     * @param {Object} response - contains the response from the service.
  ...
  SettingsNew_PresentationController.prototype.fetchEligibleSignatoryUsers = function(payLoad){
    applicationManager.getSettingsApprovalManager().getEligibleSignatoryUsers(payLoad,this.fetchEligibleSignatoryUsersSuccess.bind(this), this.fetchEligibleSignatoryUsersFailure.bind(this));
   };
    /**
     * Method used as failure call back for the add new address.
     * @param {String} errorMessage - contains the error message of the service call.
  ...
  SettingsNew_PresentationController.prototype.createSignatoryGroup = function(payLoad){
    applicationManager.getSettingsApprovalManager().createSignatoryGroup(payLoad,this.createSignatoryGroupSuccess.bind(this), this.createSignatoryGroupFailure.bind(this));
  };
  /**
     * Method used as failure call back for the add new address.
     * @param {String} errorMessage - contains the error message of the service call.
  ...
  SettingsNew_PresentationController.prototype.createSignatoryGroupFailure = function(errorMessage) {
   ...
   SettingsNew_PresentationController.prototype.fetchEligibleSignatoryUsersForAddUSers = function(payLoad){
    ...
    applicationManager.getSettingsApprovalManager().getEligibleSignatoryUsers(payLoad,this.fetchEligibleSignatoryUsersForAddUSersSuccess.bind(this), this.fetchEligibleSignatoryUsersForAddUSersFailure.bind(this));
   };
    /**
     * Method used as failure call back for the add new address.
     * @param {String} errorMessage - contains the error message of the service call.
  ...
  SettingsNew_PresentationController.prototype.checkSigGrpAvailability = function(payLoad){
    applicationManager.getSettingsApprovalManager().checkSigGrpAvailability(payLoad,this.checkSigGrpAvailabilitySuccess.bind(this), this.checkSigGrpAvailabilityFailure.bind(this));
  };
  /**
     * Method used as failure call back for the add new address.
     * @param {String} errorMessage - contains the error message of the service call.
  ...
  SettingsNew_PresentationController.prototype.checkSigGrpAvailabilityFailure = function(errorMessage) {
  	 ...
  	 SettingsNew_PresentationController.prototype.isSignatoryGroupEligibleForDelete = function(input) {
		...
		applicationManager.getSettingsApprovalManager().isSignatoryGroupEligibleForDelete(signatoryId, this.isSignatoryGroupEligibleForDeleteSuccess.bind(this), this.isSignatoryGroupEligibleForDeleteFailure.bind(this));
	 };
    ...
    SettingsNew_PresentationController.prototype.deleteSignatoryGroup = function(input) {
		...
		applicationManager.getSettingsApprovalManager().deleteSignatoryGroup(data, this.deleteSignatoryGroupSuccess.bind(this), this.deleteSignatoryGroupFailue.bind(this));
   ...
   SettingsNew_PresentationController.prototype.getUserApprovalPermissions = function(input,segData) {
      ...
      applicationManager.getNavigationManager().navigateTo("frmViewPermissionSignatoryGroups");
        applicationManager.getSettingsApprovalManager().getUserApprovalPermissions(data, this.getUserApprovalPermissionsSuccess.bind(this,segData), this.getUserApprovalPermissionsFailue.bind(this,segData));
    };
    ...
    SettingsNew_PresentationController.prototype.removeUsers = function(context) {
      applicationManager.getSettingsApprovalManager().updateSignatoryGroup(context, this.removeUsersSuccess.bind(this), this.removeUsersFailure.bind(this));
    };
    /**
     * Method to update the Signatory group with remove users
     * @param {Object} response - contains the response from the service.
...
/**
  ...
  SettingsNew_PresentationController.prototype.fetchAllSignatoryGroups = function(request) {
   ...
   // var contracts = applicationManager.getUserPreferencesManager().getUserObj().CoreCustomers;
    ...
    applicationManager.getSettingsApprovalManager().getAllSignatoryGroups(input,this.getAllSignatoryGroupData.bind(this,request),this.getAllSignatoryGroupsFailue.bind(this) );
  };
