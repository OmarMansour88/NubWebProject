...
//         },
      ...
      kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("SettingsNewApprovalUIModule").presentationController.fetchEligibleSignatoryUsersForAddUSers(filterKey);
    },
      ...
      deleteSignatoryGroup : function (res){
        ...
        if(status === "true" || status === true) {
          ...
          this.view.PopupHeaderUM.btnYes.onClick = function() {
            kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("SettingsNewApprovalUIModule").presentationController.deleteSignatoryGroup(scope.signatoryGroupId);
          };
      ...
      checkEgilibleDelete : function () {
             this.resetUI();
			 kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("SettingsNewApprovalUIModule").presentationController.isSignatoryGroupEligibleForDelete(this.signatoryGroupId);
		},
        setSignatoryGroupDetails: function(response) {
            ...
            this.sortContractsData("imgUserName", this.getSignatoryGroupWidgetDataMap()["lblUserNameValue"]);
            var scope = this;
          ...
          filterData.forEach(function(item){
            ...
            //                     kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("SettingsNewUIModule").presentationController.deleteSignatoryGroup();
            //                 };
          ...
          this.view.FilterSignatoryGroup.btnCancelFilter.onClick = function (){
            scope.view.FilterSignatoryGroup.imgAllUsersDropdown.text = "O";
      ...
      filterData : function(){
            ...
            data.forEach(contract => {
              ...
              contract.lblViewPermissions= {
                ...
                "onTouchEnd" : function (eventobject,content,x,y){
                  ...
                  kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("SettingsNewApprovalUIModule").presentationController.getUserApprovalPermissions(input,segData);
		...
		sortContractsData: function(imgWidget, sortKey) {
            ...
            if(imgWidget!== "imgRequestTypeApprovePending")segmentData[0][0]["imgRequestTypeApprovePending"].src = "sorting.png";
            if(imgWidget!== "imgAddedOn")segmentData[0][0]["imgAddedOn"].src = "sorting.png";
            if(imgWidget!== "imgUserRole")segmentData[0][0]["imgUserRole"].src = "sorting.png";
            if(imgWidget!== "imgUserName")segmentData[0][0]["imgUserName"].src = "sorting.png";
            var settingsnew = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("SettingsNewApprovalUIModule").presentationController;
      ...
      onBreakpointChange: function(width) {
        ...
        btnViewEditOnclick: function() {
          ...
          scope.view.flxEditGroupDetails.lblcross.onTouchEnd = function() {
                scope.view.flxPopupConfirmation.setVisibility(false);
          };
