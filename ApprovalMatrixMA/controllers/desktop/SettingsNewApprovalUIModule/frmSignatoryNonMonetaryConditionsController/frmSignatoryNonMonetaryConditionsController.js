define(['FormControllerUtility'], function(FormControllerUtility) {
  ...
  return {
    ...
    frmPreShow: function() {
      ...
      this.rangeDetails = applicationManager.getNavigationManager().getCustomInfo("SELECTED_NONMONETARY");
      //this.rangeDetails["NON_MONETARY_LIMIT"].groupRule = "[[1,2],[2,1]]";
      //this.rangeDetails["NON_MONETARY_LIMIT"].groupList = "[04e05658-be1f-457f-890c-61e4a0ec12be,1a08354a-5fa0-4962-91c4-84814d32ab6f]";

      this.updateCustomerDetails();
      this.view.btnAddNewCondition.zIndex = -1;
      this.view.btnConfirmSave.onClick = function(){
        this.invokeConfirmPopup();
      }.bind(this); 
      this.view.confirmpopup.formActionsNew.btnNext.onClick=this.manipulateRulesConditions;
      this.view.confirmpopup.formActionsNew.btnCancel.onClick = this.dismissConfirmPopup;
      this.view.imgEnableCondition.onTouchEnd = this.enableApproveRequired;
      this.view.imgAckClose.onTouchEnd = function(){
        scope.view.flxAcknowledgementPopup.setVisibility(false);
      };
      
      navMan.setCustomInfo("NONMONETARY_MESSAGE","Rule created successfully!");
      ...
      this.view.btnCancel.onClick = function(){
        ...
        navMan.setCustomInfo("NONMONETARY_MESSAGE","");
      ...
      this.view.btnAddCondition.onClick = this.addNonMonetaryCondition;
      this.view.imgDeleteAction.onTouchEnd = function(){
        scope.valueUpdated = "Yes";
        scope.view.deletepopup.formActionsNew.btnNext.onClick = scope.deleteEntireAction;
        scope.view.flxDeletePopup.deletepopup.lblPopupMsg.text = kony.i18n.getLocalizedString("i18n.approvals.lblmsgDeleteCondition");
        scope.view.flxDeletePopup.deletepopup.lblHeader.text = kony.i18n.getLocalizedString("i18n.approvals.headerDeleteCondition");
      ...
      this.view.btnDeleteRule.onClick = function(){
        scope.valueUpdated = "Yes";
        scope.view.deletepopup.formActionsNew.btnNext.onClick = function(){
          scope.view.imgEnableCondition.src = "inactive.png";
          scope.manipulateRulesConditions();
          navMan.setCustomInfo("NONMONETARY_MESSAGE","Rule deleted successfully!");
        };
        scope.view.flxDeletePopup.deletepopup.lblPopupMsg.text = kony.i18n.getLocalizedString("i18n.signatory.deletetherule");
        scope.view.flxDeletePopup.deletepopup.lblHeader.text = kony.i18n.getLocalizedString("i18n.approvals.headerDeleteRule");
        scope.view.flxDeletePopup.setVisibility(true);
      };
    ...
    postShowFun:function(){
      this.view.lblApprovalMatrixHeader.text = "Approval Matrix - Create Rule ";
      if (!kony.sdk.isNullOrUndefined(this.rangeDetails["NON_MONETARY_LIMIT"][0].groupRule) && this.rangeDetails["NON_MONETARY_LIMIT"][0].groupRule !== "[]") {
        this.nonMonetaryEditData();
        this.editApprovalConditions(this.rangeDetails["NON_MONETARY_LIMIT"][0].groupRule, this.rangeDetails["NON_MONETARY_LIMIT"][0].groupList);
        var navMan = applicationManager.getNavigationManager();
        navMan.setCustomInfo("NONMONETARY_MESSAGE","Rule updated successfully!");
        this.view.btnDeleteRule.setVisibility(true);
        this.unfilledData = "";
        this.view.lblApprovalMatrixHeader.text = "Approval Matrix - Edit Rule ";
      }
      FormControllerUtility.disableButton(this.view.btnConfirmSave);
      this.valueUpdated = "";
    },

    nonMonetaryEditData:function(){
      this.view.lblViewEditCondition.text = "View/Edit condition below";
      this.view.imgEnableCondition.src = "activecheckbox.png";
      this.view.btnAddCondition.setVisibility(false);
      this.view.lblViewEditCondition.setVisibility(true);
      this.view.lblApprovalConditionAction.setVisibility(true);
      this.view.imgDeleteAction.setVisibility(true);
      this.view.flxViewEditHeade.setVisibility(true);
      //this.view.flxApprovalDetailsContainer.height = "53%";
      this.view.flxApprovalConditionContainer.height = "775dp";
      this.view.flxApprovalDetailsContainer.height = "350dp";
      this.view.flxConditionPartMain.setVisibility(true);
      this.view.btnAddNewCondition.setVisibility(true);
      this.addedCondition = "Yes";
    },

    deleteEntireAction:function(){
      this.valueUpdated = "Yes";
      this.addedCondition  = "";
      this.view.flxConditionPartMain.removeAll(this.view.flxConditionPartMain.widgets());
      this.view.flxViewEditHeade.setVisibility(false);
      this.view.flxApprovalConditionContainer.height = "725dp";
      this.view.flxApprovalDetailsContainer.height = "350dp";
      this.view.flxConditionPartMain.setVisibility(false);
      this.view.btnAddNewCondition.setVisibility(false);
      this.view.imgDeleteAction.setVisibility(false);
      this.view.flxDeletePopup.setVisibility(false);
      this.view.lblViewEditCondition.text = "N/A";
      this.view.lblViewEditCondition.setVisibility(false);
      this.view.btnAddCondition.setVisibility(true);
      this.sectionCount = 0;
      this.conditionCount = {};
      this.conditionFlex = [];
      this.andConditionFlex = {};
      ...
      this.prevCurrenctCondition = "";
      this.prevdropDownName = "";
      this.view.lblAckNotificationContent.text = "Conditions deleted successfully!";
      this.view.flxAcknowledgementPopup.setVisibility(true);
    },

    addNonMonetaryCondition:function(){
      this.valueUpdated = "Yes";
      this.addedCondition = "Yes";
      this.view.lblViewEditCondition.text = "View/Edit condition below";
      this.view.flxApprovalConditionContainer.height = "775dp";
    ...
    enableApproveRequired:function(){
      this.valueUpdated = "Yes";
      if(this.addedCondition === "Yes"){
        if(this.view.imgEnableCondition.src === "inactive.png"){
          this.view.lblViewEditCondition.text = "View/Edit condition below";
          this.view.imgEnableCondition.src = "activecheckbox.png";
          this.view.btnAddCondition.setVisibility(false);
          this.view.lblViewEditCondition.setVisibility(true);
          ...
          this.view.flxViewEditHeade.setVisibility(true);
          //this.view.flxApprovalDetailsContainer.height = "53%";
          this.view.flxApprovalConditionContainer.height = this.heightDetails["mainContainer"] ;
          this.view.flxApprovalDetailsContainer.height = this.heightDetails["detailsContainer"] ;
          this.view.flxConditionPartMain.setVisibility(true);
          this.view.btnAddNewCondition.setVisibility(true);
          FormControllerUtility.enableButton(this.view.btnConfirmSave);
        }else{
          this.view.imgEnableCondition.src = "inactive.png";
          this.view.btnAddCondition.setVisibility(false);
          this.view.lblViewEditCondition.text = "N/A";
          this.view.lblViewEditCondition.setVisibility(true);
          this.view.lblApprovalConditionAction.setVisibility(false);
          this.view.imgDeleteAction.setVisibility(false);
          this.view.flxViewEditHeade.setVisibility(false);
          this.heightDetails["mainContainer"] = this.view.flxApprovalConditionContainer.height;
          this.heightDetails["detailsContainer"] = this.view.flxApprovalDetailsContainer.height;
          this.view.flxApprovalConditionContainer.height = "725dp";
          this.view.flxApprovalDetailsContainer.height = "350dp";
          this.view.flxConditionPartMain.setVisibility(false);
          this.view.btnAddNewCondition.setVisibility(false);
    ...
    updateCustomerDetails:function(){
      ...
      this.view.lblFeatureActionValue.text = this.rangeDetails["featureName"]+" - "+this.rangeDetails["actionName"];
	  if(kony.sdk.isNullOrUndefined(feature["isAccountLevel"]) || feature["isAccountLevel"] == "1") {
        this.view.lblActionLevelValue.text = kony.i18n.getLocalizedString("i18n.serviceRequests.Account");
      } else {
        this.view.lblActionLevelValue.text = kony.i18n.getLocalizedString("i18n.approvals.customer");
      }
    },
    ...
    addNewCondition:function(){
      ...
      var detailsContainer = parseInt(this.view.flxApprovalDetailsContainer.height);
      mainFlexHeight = mainFlexHeight + 135;
      detailsContainer = detailsContainer+ 135;
      this.view.flxApprovalConditionContainer.height = mainFlexHeight+"dp";
      this.view.flxApprovalDetailsContainer.height = detailsContainer+"dp";
    ...
    deletePopupEnable:function(flexType,sectionCount,currentCondition){
      var scope = this;
      this.view.flxDeletePopup.deletepopup.lblPopupMsg.text = kony.i18n.getLocalizedString("i18n.approvals.lblmsgDeleteCondition");
      this.view.flxDeletePopup.deletepopup.lblHeader.text = kony.i18n.getLocalizedString("i18n.approvals.headerDeleteCondition");
    ...
    addNewANDCondition:function(sectionCount){
      ...
      detailsContainer = detailsContainer + 170;
      this.view.flxApprovalConditionContainer.height = mainFlexHeight+"dp";
      this.view.flxApprovalDetailsContainer.height = detailsContainer+"dp";
    ...
    deleteCondition: function(sectionCount) {
      ...
      detailsContainer = detailsContainer - 130;
      this.view.flxApprovalConditionContainer.height = mainFlexHeight+"dp";
      this.view.flxApprovalDetailsContainer.height = detailsContainer+"dp";
    ...
    manipulateRulesConditions: function() {
      ...
      if(this.view.imgEnableCondition.src === "inactive.png"){
        requestPara = {
          "actionId": scope.rangeDetails.actionId,
          "limitTypeId": "NON_MONETARY_LIMIT",
          "cif": accountDetails.coreCustomerID,
        ...
        var sectionCount = Object.keys(this.andConditionFlex).length;
        var approveGrp = [];
        var groupList = "[";
        /*for (var i = 0; i < sectionCount; i++) {
          if (!kony.sdk.isNullOrUndefined(this.andConditionFlex["section" + i])) {
            for (var j = 0; j < this.andConditionFlex["section" + i].length; j++) {
              ...
              fromGroup = this.signatoryByName[fromGroup].signatoryGroupId;
              if(!approveGrp.includes(fromGroup)) {
                approveGrp.push(fromGroup);
              }
            }
          }
        }*/
        ...
        /*      for (var z = 0; z < sectionCount; z++) {
          ...
          var appRule = "[";
          if (!kony.sdk.isNullOrUndefined(this.andConditionFlex["section" + z])) {
            for (var m = 0; m < this.andConditionFlex["section" + z].length; m++) {
              var conditionNo = this.andConditionFlex["section" + z][m];
      ...
      if(!scope.isEmptyNullorUndefined(accountDetails.accountId)){
        requestPara["accountId"] = accountDetails["accountId"];
      }
      this.presenter.updateApprovalMatrixSG(requestPara);
    },
