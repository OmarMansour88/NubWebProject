...
AddPerformanceLineChart.bind(null, data.xData, data.portfolioReturn, data.benchmarkReturn, data.filter, data.portfolioColor, data.benchmarkColor) : null
      ...
      // $(document).ready(AddPerformanceLineChart.bind(null, data.xData, data.portfolioReturn, data.benchmarkReturn, data.filter, data.portfolioColor, data.benchmarkColor));
      }
    }
};