    ...
    Chartist.plugins.tooltip2 = function(options) {
        ...
        return function tooltip(chart) {
            ...
            function setTooltipPosition(relativeElement, ignoreClasses) {
                ...
                tooltipElement.style.transform = 'translate(' + positionData.left + 'px, ' + (positionData.top + 10) + 'px)';
            ...
            function getTooltipPosition(relativeElement) {
				...
				left = boxData.left + window.scrollX   + boxData.width/2;
                top = boxData.top + window.scrollY + height+ options.offset.y ;
				}
				else{
                left = boxData.left + window.scrollX + options.offset.x - width / 2 + boxData.width / 2;
                top = boxData.top + window.scrollY - height + options.offset.y;
				}
