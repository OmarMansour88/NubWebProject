define(function() {
  var konyLoggerModule = require('com/InfinityMB/PortfolioManagementMA/socialshare/konyLogger');
  var konymp = konymp || {};
        ...
        this.getNativeController = function() {
            try {
                ...
                if (this.nativeControllerInstance === undefined) {
                    ...
                    var nativeControllerPath = 'com/InfinityMB/PortfolioManagementMA/' + 'socialshare' + '/NativeController' + platformName + '.js';
