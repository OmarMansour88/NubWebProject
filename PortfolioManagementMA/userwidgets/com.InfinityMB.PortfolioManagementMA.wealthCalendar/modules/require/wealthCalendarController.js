define(function () {
  return {
    ...
    setSelectedDate: function (dateParam) {
      ...
      var today = new Date();
      var dateParam1 = (today.getMonth()+1)+"/"+today.getDate()+"/"+today.getFullYear();
      if(dateParam != dateParam1){
        currForm.btnPeriodicDays.skin = "sknIWBtnBgFFFFFFBorder1px003E7540px";
        currForm.btnThreeMonths.skin = "sknIWBtnBgFFFFFFBorder1px003E7540px";
        currForm.btnSixMonths.skin = "sknIWBtnBgFFFFFFBorder1px003E7540px";
        currForm.btnLastYear.skin = "sknIWBtnBgFFFFFFBorder1px003E7540px";
      }
    ...
    preShow: function () {
      ...
      this.holidays = navManager.getCustomInfo("customCalendar");
      if(!this.holidays)
    ...
    updateDateBullets: function () {
      ...
      var response = navMan.getCustomInfo('frmDateRange');
...
//         dummy = 'MM/DD/YYYY';
        ...
        currForm.btnContinue.skin = 'sknBtn055BAF26px';
