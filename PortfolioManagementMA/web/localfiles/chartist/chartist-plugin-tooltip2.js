...
(function(window, document, Chartist) {
    ...
    var publicOptions = {
        ...
        template: '<span class="tooltip-text1">{{xDate}} </span>  </br> <span class="tooltip-text2">{{currencySymbol}} {{formattedAmount}}</span></br> <span class="{{percentageClass}}">{{percentage}}</span>',
            ...
            function init() {
                ...
                if (chart instanceof Chartist.Line) {
                    chart.on('created', function() {
                        chart.container.querySelector('svg').addEventListener('click', prepareLineTooltip);
