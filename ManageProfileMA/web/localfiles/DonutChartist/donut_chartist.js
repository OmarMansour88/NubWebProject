...
var drawCanvasChart = function(filename,chartData,chartLabels,chartColors) {
	...
	if(chartData === undefined || chartData === null || chartData === "") {
	...
	if(chartLabels === undefined || chartLabels === null || chartLabels === "") {
	...
	if(chartColors === undefined || chartColors === null || chartColors === "") {
