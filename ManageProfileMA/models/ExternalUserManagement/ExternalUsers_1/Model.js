...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "ExternalUsers_1", "objectService" : "ExternalUserManagement"};
    ...
    var setterFunctions = {
        ...
        primaryApplicantId: function(val, state) {
            context["field"] = "primaryApplicantId";
            context["metadata"] = (objectMetadata ? objectMetadata["primaryApplicantId"] : null);
            state['primaryApplicantId'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        coApplicantId: function(val, state) {
            context["field"] = "coApplicantId";
            context["metadata"] = (objectMetadata ? objectMetadata["coApplicantId"] : null);
            state['coApplicantId'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        applicantId: function(val, state) {
            context["field"] = "applicantId";
            context["metadata"] = (objectMetadata ? objectMetadata["applicantId"] : null);
            state['applicantId'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        ...
        groups: function(val, state) {
            context["field"] = "groups";
            context["metadata"] = (objectMetadata ? objectMetadata["groups"] : null);
            state['groups'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        ...
        isUserRemoved: function(val, state) {
            context["field"] = "isUserRemoved";
            context["metadata"] = (objectMetadata ? objectMetadata["isUserRemoved"] : null);
            state['isUserRemoved'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        isAssigned: function(val, state) {
            context["field"] = "isAssigned";
            context["metadata"] = (objectMetadata ? objectMetadata["isAssigned"] : null);
            state['isAssigned'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
    ...
    function ExternalUsers_1(defaultValues) {
        var privateState = {};
        context["field"] = "userDetails";
        context["metadata"] = (objectMetadata ? objectMetadata["userDetails"] : null);
        ...
        context["field"] = "primaryApplicantId";
        context["metadata"] = (objectMetadata ? objectMetadata["primaryApplicantId"] : null);
        privateState.primaryApplicantId = defaultValues ?
            (defaultValues["primaryApplicantId"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["primaryApplicantId"], context) :
                null) :
            null;

        context["field"] = "coApplicantId";
        context["metadata"] = (objectMetadata ? objectMetadata["coApplicantId"] : null);
        privateState.coApplicantId = defaultValues ?
            (defaultValues["coApplicantId"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["coApplicantId"], context) :
                null) :
            null;

        context["field"] = "applicantId";
        context["metadata"] = (objectMetadata ? objectMetadata["applicantId"] : null);
        privateState.applicantId = defaultValues ?
            (defaultValues["applicantId"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["applicantId"], context) :
                null) :
            null;
        ...
        context["field"] = "groups";
        context["metadata"] = (objectMetadata ? objectMetadata["groups"] : null);
        privateState.groups = defaultValues ?
            (defaultValues["groups"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["groups"], context) :
                null) :
            null;
        ...
        context["field"] = "isUserRemoved";
        context["metadata"] = (objectMetadata ? objectMetadata["isUserRemoved"] : null);
        privateState.isUserRemoved = defaultValues ?
            (defaultValues["isUserRemoved"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["isUserRemoved"], context) :
                null) :
            null;

        context["field"] = "isAssigned";
        context["metadata"] = (objectMetadata ? objectMetadata["isAssigned"] : null);
        privateState.isAssigned = defaultValues ?
            (defaultValues["isAssigned"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["isAssigned"], context) :
                null) :
            null;
        ...
        Object.defineProperties(this, {
            ...
            "primaryApplicantId": {
                get: function() {
                    context["field"] = "primaryApplicantId";
                    context["metadata"] = (objectMetadata ? objectMetadata["primaryApplicantId"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.primaryApplicantId, context);
                },
                set: function(val) {
                    setterFunctions['primaryApplicantId'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "coApplicantId": {
                get: function() {
                    context["field"] = "coApplicantId";
                    context["metadata"] = (objectMetadata ? objectMetadata["coApplicantId"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.coApplicantId, context);
                },
                set: function(val) {
                    setterFunctions['coApplicantId'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "applicantId": {
                get: function() {
                    context["field"] = "applicantId";
                    context["metadata"] = (objectMetadata ? objectMetadata["applicantId"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.applicantId, context);
                },
                set: function(val) {
                    setterFunctions['applicantId'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "signatoryGroups": {
            ...
            "groups": {
                get: function() {
                    context["field"] = "groups";
                    context["metadata"] = (objectMetadata ? objectMetadata["groups"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.groups, context);
                },
                set: function(val) {
                    setterFunctions['groups'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "signatoryGroupId": {
            ...
            "isUserRemoved": {
                get: function() {
                    context["field"] = "isUserRemoved";
                    context["metadata"] = (objectMetadata ? objectMetadata["isUserRemoved"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.isUserRemoved, context);
                },
                set: function(val) {
                    setterFunctions['isUserRemoved'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "isAssigned": {
                get: function() {
                    context["field"] = "isAssigned";
                    context["metadata"] = (objectMetadata ? objectMetadata["isAssigned"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.isAssigned, context);
                },
                set: function(val) {
                    setterFunctions['isAssigned'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "taxId": {
        ...
        this.fromJsonInternal = function(value) {
            ...
            privateState.primaryApplicantId = value ? (value["primaryApplicantId"] ? value["primaryApplicantId"] : null) : null;
            privateState.coApplicantId = value ? (value["coApplicantId"] ? value["coApplicantId"] : null) : null;
            privateState.applicantId = value ? (value["applicantId"] ? value["applicantId"] : null) : null;
            privateState.signatoryGroups = value ? (value["signatoryGroups"] ? value["signatoryGroups"] : null) : null;
            privateState.groups = value ? (value["groups"] ? value["groups"] : null) : null;
            ...
            privateState.isUserRemoved = value ? (value["isUserRemoved"] ? value["isUserRemoved"] : null) : null;
            privateState.isAssigned = value ? (value["isAssigned"] ? value["isAssigned"] : null) : null;
    ...
    BaseModel.isParentOf(ExternalUsers_1);

    //Create new class level validator object
    BaseModel.Validator.call(ExternalUsers_1);

    var registerValidatorBackup = ExternalUsers_1.registerValidator;

    ExternalUsers_1.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(ExternalUsers_1.isValid(this, propName, val)) {
    ...
    //For Operation 'createInfinityProspect' with service id 'CreateProspectOperation3370'
     ExternalUsers_1.createInfinityProspect = function(params, onCompletion){
        return ExternalUsers_1.customVerb('createInfinityProspect', params, onCompletion);
     };

    //For Operation 'getCustomersForUser' with service id 'getAssociatedCustomers1309'
     ExternalUsers_1.getCustomersForUser = function(params, onCompletion){
        return ExternalUsers_1.customVerb('getCustomersForUser', params, onCompletion);
     };

    //For Operation 'getInfinityUserContractDetails' with service id 'GetInfinityUserContractDetails7453'
     ExternalUsers_1.getInfinityUserContractDetails = function(params, onCompletion){
        return ExternalUsers_1.customVerb('getInfinityUserContractDetails', params, onCompletion);
     };

    //For Operation 'editUser' with service id 'editInfinityUser4362'
     ExternalUsers_1.editUser = function(params, onCompletion){
        return ExternalUsers_1.customVerb('editUser', params, onCompletion);
     };

    //For Operation 'assignInfinityUserToPrimaryRetailContract' with service id 'assignInfinityUserToPrimaryRetailContract7867'
     ExternalUsers_1.assignInfinityUserToPrimaryRetailContract = function(params, onCompletion){
        return ExternalUsers_1.customVerb('assignInfinityUserToPrimaryRetailContract', params, onCompletion);
     };

    //For Operation 'getUsersFromContract' with service id 'GetAssociatedContractUsers3892'
     ExternalUsers_1.getUsersFromContract = function(params, onCompletion){
        return ExternalUsers_1.customVerb('getUsersFromContract', params, onCompletion);
     };

    //For Operation 'enrollRetailUser' with service id 'EnrollRetailUser3249'
     ExternalUsers_1.enrollRetailUser = function(params, onCompletion){
        return ExternalUsers_1.customVerb('enrollNuranRetailUser', params, onCompletion);
     };

    //For Operation 'getInfinityUserLimits' with service id 'GetInfinityUserLimits1247'
     ExternalUsers_1.getInfinityUserLimits = function(params, onCompletion){
        return ExternalUsers_1.customVerb('getInfinityUserLimits', params, onCompletion);
     };

    //For Operation 'GetListCoreCustomerFeatureActionLimits' with service id 'GetListCoreCustomerFeatureActionLimits3221'
     ExternalUsers_1.GetListCoreCustomerFeatureActionLimits = function(params, onCompletion){
        return ExternalUsers_1.customVerb('GetListCoreCustomerFeatureActionLimits', params, onCompletion);
     };

    //For Operation 'getInfinityUserContractCoreCustomerActions' with service id 'GetInfinityUserContractCoreCustomerActions3789'
     ExternalUsers_1.getInfinityUserContractCoreCustomerActions = function(params, onCompletion){
        return ExternalUsers_1.customVerb('getInfinityUserContractCoreCustomerActions', params, onCompletion);
     };

    //For Operation 'CreateInfinityUserWithContract' with service id 'CreateInfinityUserWithContract3507'
     ExternalUsers_1.CreateInfinityUserWithContract = function(params, onCompletion){
        return ExternalUsers_1.customVerb('CreateInfinityUserWithContract', params, onCompletion);
     };

    //For Operation 'getRelatedCustomers' with service id 'getAllEligibleRelationalCustomers6195'
     ExternalUsers_1.getRelatedCustomers = function(params, onCompletion){
        return ExternalUsers_1.customVerb('getRelatedCustomers', params, onCompletion);
     };

    //For Operation 'updateInfinityUserStatus' with service id 'UpdateInfinityUserStatus6443'
     ExternalUsers_1.updateInfinityUserStatus = function(params, onCompletion){
        return ExternalUsers_1.customVerb('updateInfinityUserStatus', params, onCompletion);
     };

    //For Operation 'getInfinityUserAccounts' with service id 'GetInfinityUserAccounts1944'
     ExternalUsers_1.getInfinityUserAccounts = function(params, onCompletion){
        return ExternalUsers_1.customVerb('getInfinityUserAccounts', params, onCompletion);
     };

    //For Operation 'resendActivationCode' with service id 'SendInfinityUserUserNameAndActivationCode2697'
     ExternalUsers_1.resendActivationCode = function(params, onCompletion){
        return ExternalUsers_1.customVerb('resendActivationCode', params, onCompletion);
     };

    //For Operation 'getInfinityUserFeatureActions' with service id 'GetInfinityUserFeatureActions4845'
     ExternalUsers_1.getInfinityUserFeatureActions = function(params, onCompletion){
        return ExternalUsers_1.customVerb('getInfinityUserFeatureActions', params, onCompletion);
     };

    //For Operation 'createRetailContract' with service id 'CreateRetailContract9160'
     ExternalUsers_1.createRetailContract = function(params, onCompletion){
        return ExternalUsers_1.customVerb('createRetailContract', params, onCompletion);
     };

    //For Operation 'getCoreCustomerFeatureActionLimits' with service id 'GetCoreCustomerFeatureActionLimits8284'
     ExternalUsers_1.getCoreCustomerFeatureActionLimits = function(params, onCompletion){
        return ExternalUsers_1.customVerb('getCoreCustomerFeatureActionLimits', params, onCompletion);
     };

    //For Operation 'getCustomRoleByCompanyID' with service id 'GetCustomRoleByCompanyID5803'
     ExternalUsers_1.getCustomRoleByCompanyID = function(params, onCompletion){
        return ExternalUsers_1.customVerb('getCustomRoleByCompanyID', params, onCompletion);
     };

    //For Operation 'getUserDetails' with service id 'getInfinityUser6429'
     ExternalUsers_1.getUserDetails = function(params, onCompletion){
        return ExternalUsers_1.customVerb('getUserDetails', params, onCompletion);
     };

    //For Operation 'getUserApprovalPermissions' with service id 'GetUserApprovalPermissions5351'
     ExternalUsers_1.getUserApprovalPermissions = function(params, onCompletion){
        return ExternalUsers_1.customVerb('getUserApprovalPermissions', params, onCompletion);
     };

    //For Operation 'createBusinessContract' with service id 'CreateBusinessContract6320'
     ExternalUsers_1.createBusinessContract = function(params, onCompletion){
        return ExternalUsers_1.customVerb('createBusinessContract', params, onCompletion);
     };

    //For Operation 'updateInfinityProspect' with service id 'UpdateProspect8581'
     ExternalUsers_1.updateInfinityProspect = function(params, onCompletion){
        return ExternalUsers_1.customVerb('updateInfinityProspect', params, onCompletion);
     };

    //For Operation 'getInfinityUserContractCustomers' with service id 'GetInfinityUserContractCustomers6762'
     ExternalUsers_1.getInfinityUserContractCustomers = function(params, onCompletion){
        return ExternalUsers_1.customVerb('getInfinityUserContractCustomers', params, onCompletion);
     };

    //For Operation 'createUser' with service id 'createInfinityUser3399'
     ExternalUsers_1.createUser = function(params, onCompletion){
        return ExternalUsers_1.customVerb('createUser', params, onCompletion);
     };

    var relations = [];

    ExternalUsers_1.relations = relations;

    ExternalUsers_1.prototype.isValid = function() {
        return ExternalUsers_1.isValid(this);
    };

    ExternalUsers_1.prototype.objModelName = "ExternalUsers_1";
     ...
     */
    ExternalUsers_1.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("ExternalUserManagement", "ExternalUsers_1", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    ExternalUsers_1.clone = function(objectToClone) {
        var clonedObj = new ExternalUsers_1();
        clonedObj.fromJsonInternal(objectToClone.toJsonInternal());
        return clonedObj;
    };

    return ExternalUsers_1;
});