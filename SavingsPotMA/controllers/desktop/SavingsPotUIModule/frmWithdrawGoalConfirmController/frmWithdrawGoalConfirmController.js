define(["CommonUtilities", "FormControllerUtility", "OLBConstants", "ViewConstants"], function(CommonUtilities, FormControllerUtility, OLBConstants, ViewConstants) {
    ...
    return {
         ...
         *@param {Object} withdrawGoalConfirm view model object
         */
        ...
        /**
         * setDataToConfirmUI : method that binds goal data to form .
         *@member of{frmWithdrawGoalConfirmController}
        ...
        setDataToConfirmUI: function(goalData) {
            ...
            this.view.confirmation.lblConfirmValue5.text = CommonUtilities.formatCurrencyWithCommas(goalData.withdrawAmount, false, accountCurrencyCode);
        ...
        onClickContinue: function(goalData) {
            ...
            var params = {
                ...
                "amount": goalData.withdrawAmount,
                "isCreditDebit": "Debit"
            }
            this.savingsPotPresentationController.withdrawGoal(goalData, params);
        },
        /**
        ...
        onClickModify: function(goalData) {
            FormControllerUtility.showProgressBar(this.view);
            this.savingsPotPresentationController.presentUserInterface("frmWithdrawGoal", {
