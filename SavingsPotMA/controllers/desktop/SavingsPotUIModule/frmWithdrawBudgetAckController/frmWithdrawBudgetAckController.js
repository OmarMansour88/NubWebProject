define(["CommonUtilities", "FormControllerUtility", "OLBConstants", "ViewConstants"], function(CommonUtilities, FormControllerUtility, OLBConstants, ViewConstants) {
    ...
    return {
         ...
         *@param {Object} withdrawBudgetAck view model object
         */
        updateFormUI: function(uiData) {
            if (uiData) {
                ...
                if (uiData.budgetSuccess) {
                    this.setDataToAckForm(uiData.budgetSuccess);
                }
         ...
         *�@member�of�{frmWithdrawBudgetAckController}
         *�@param�{Object} budgetData - data 
         *�@return�{}
         *�@throws�{}
         */
        setDataToAckForm: function(budgetData) {
            ...
            this.view.acknowledgment.lblAckDetailValue1.text = budgetData.potName;
            ...
            this.view.acknowledgment.lblAckDetailValue4.text = CommonUtilities.formatCurrencyWithCommas(budgetData.availableBalance - budgetData.withdrawAmount, false, currencySymbol);
            this.view.acknowledgment.lblAckDetailValue5.text = CommonUtilities.formatCurrencyWithCommas(budgetData.withdrawAmount, false, currencySymbol);
            ...
            this.view.acknowledgment.lblBalanceValue.text = CommonUtilities.formatCurrencyWithCommas(budgetData.availableBalance - budgetData.withdrawAmount, false, currencySymbol);
        },
