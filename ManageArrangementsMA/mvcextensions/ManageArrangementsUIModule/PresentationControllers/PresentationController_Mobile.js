define([], function() {
  ...
  Settings_PresentationController.prototype.setDataDefaultLogin = function(selectedAcntRow){
    if(selectedAcntRow === 0){
      ...
      new kony.mvc.Navigation({
		"friendlyName": "ManageArrangementsUIModule/frmSetDefaultAccount",
  ...
  Settings_PresentationController.prototype.presentationAccountsSucc = function(successRes){
    ...
    new kony.mvc.Navigation({
			 "friendlyName": "ManageArrangementsUIModule/frmEStmtAccountPreferences",
                "appName": "ManageArrangementsMA"
            }).navigate();
  ...
  Settings_PresentationController.prototype.updateJsonData = function(){
    ...
    var feedbackModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule({"moduleName" : "FeedbackUIModule","appName" :"AboutUsMA"});
    feedbackModule.presentationController.showFeedbackPopup({ from: "profilesettingorlogout" });
  };
  /**
...
*/
  ...
  */
  ...
  Settings_PresentationController.prototype.termsAndConditionSuccessCallback = function(response){
    var settingsModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("ManageArrangementsUIModule");
    var navManager = applicationManager.getNavigationManager();
    ...
    if(response.contentTypeId == "URL"){
      ...
      navManager.navigateTo({"friendlyName": "ManageArrangementsUIModule/frmEStmtTermsAndConditions","appName": "ManageArrangementsMA"});
    }
  };
