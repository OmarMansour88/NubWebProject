define(['CommonUtilities', 'ViewConstants', 'FormControllerUtility', 'CampaignUtility'], function(CommonUtilities, ViewConstants, FormControllerUtility, CampaignUtility) {
    ...
    return {
        ...
        updateFormUI: function(context) {
            ...
            if (context.fetchRequestHistoryForBulkPay) {
                this.setupBulkPaymentsView(context.fetchRequestHistoryForBulkPay);
            }
        ...
        onPreShow: function() {
            ...
            this.view.customheader.forceCloseHamburger();
            this.view.customheader.customhamburger.activateMenu("Approvals Requests", kony.i18n.getLocalizedString("i18n.konybb.Common.requestHistory"));
        ...
        onBreakpointChange: function(width) {
            ...
            if (width === 640 || orientationHandler.isMobile) {
                ...
                this.view.customheader.lblHeaderMobile.text = kony.i18n.getLocalizedString("i18n.konybb.Common.requestHistory");
        ...
        loadDashboard: function() {
            this.view.TabPaneNew.TabsHeaderNew.btnTab1.isVisible = this.checkAtLeastOnePermission(applicationManager.getConfigurationManager().getBulkPaymentRequestPermissionsList());
        ...
        fetchBulkPaymentHistory: function() {
            this.updateFetchParams();
            this.ApprovalsReqModule.presentationController.fetchBulkPaymentRequestHistory(this.fetchParams);
        },
        ...
        **/
        ...
        setupRightContainer: function() {
            ...
            var scopeObj = this;
            this.view.dbRightContainerNew.lblActionHeader.text = kony.i18n.getLocalizedString("i18n.konybb.Common.requestHistory");
            ...
            this.view.dbRightContainerNew.flxAction3.isVisible = this.checkAtLeastOnePermission(applicationManager.getConfigurationManager().getBulkPaymentsApprovalsFeaturePermissionsList());
            this.view.dbRightContainerNew.btnAction3.text = kony.i18n.getLocalizedString("i18n.konybb.Common.approvalHistory");
