define(function () {
  ...
  function watchlistDashCardDAO(){

  }
  /**
     * component Watchlist Dashboard Card
     ...
     */
  watchlistDashCardDAO.prototype.fetchDetails = function(objServiceName,operationName,objName,criteria,unicode,onSuccess,onError) {
    ...
    objSvc.customVerb(operationName, options,
      ...
      var  errorObj =
          {
            "errorInfo" : "Fetch Watchlist list service call failed",
            "errorLevel" : "Fabric",
            "error": error
          }
      onError(errorObj);
      kony.print("Failed to fetch Watchlist:" + JSON.stringify(error));
    });
  };
  return watchlistDashCardDAO;
});