  ...
  return {
    ...
    setStaticData:function(){
      ...
      if(scopeObj._blockTitle1){
        ...
        scopeObj.view.lblHeaderContracts.text = scopeObj._blockTitle1;
    ...
    initializeSortActions: function() {
      ...
      scopeObj.view.imgSortColumn1.onTouchEnd = scopeObj.onSortClick.bind(scopeObj, scopeObj.view.imgSortColumn1, JSON.parse(scopeObj._column1).sortBy, JSON.parse(scopeObj._column1).sortByType);
      scopeObj.view.imgSortColumn2.onTouchEnd = scopeObj.onSortClick.bind(scopeObj, scopeObj.view.imgSortColumn2, JSON.parse(scopeObj._column2).sortBy, JSON.parse(scopeObj._column2).sortByType);
    },
