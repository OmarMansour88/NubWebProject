  ...
  return {
    ...
    setFilterField: function () {
      try {
        if (kony.application.getCurrentBreakpoint() === 640 || orientationHandler.isMobile) {
          ...
          this.view.flxFilter.width = this._isSearchEnabled ? "30.14%" : "95.6%";
          this.view.flxSegmentFilter.left = this._isSearchEnabled ? "67.66%" : "2.2%";
          this.view.flxSegmentFilter.width = this._isSearchEnabled ? "30.14%" : "95.6%";
    ...
    initActions: function () {
      try {
        ...
        this.view.flxDropdown.onTouchStart = this.toggleFilterDropdown.bind(this);
     ...
     */
    onSegFilterRowClick: function (triggerEvent) {
      try {
