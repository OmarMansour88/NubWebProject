define(['./BeneficiaryManagementDAO','./ParserUtilsManager','./AddBeneficiaryUtility','./EntitlementUtils','DataValidationFramework/DataValidationHandler'],function(BeneficiaryManagementDAO,ParserUtilsManager,AddBeneficiaryUtility,EntitlementUtils,DataValidationHandler) {
  ...
  return {
    ...
    turnOffSecondaryScreenContainers: function() {
      ...
      this.view.flxContent.flxNote.isVisible = true;
    },
   ...
   validateAccountNumber: function() {
      ...
      try {
        ...
        if ((accNumber !== "" && accNumber !== undefined) && (reenterAccNumber !== "" && reenterAccNumber !== undefined)) {
          if (accNumber === reenterAccNumber) {
            var objSvcName = this.getParsedValue("PayeeNuran");
            var objName = this.getParsedValue("Payee_Name");
            var operationName = this.getParsedValue("getPayeeName");
            ...
            function onSuccess(response) {
              ...
              if (response.beneficiaryName == "") {
                var error = "Entered account number is incorrect. Please enter the valid account number.";
    ...
    minFillValidation: function(tbxWidget) {
      ...
      (jsonToBeSent,object,minFillDvfConfig);    
      if(Object.keys(dataValidator).length ===0 &&
         dataValidator.constructor === Object){
        if(beneficiaryType === "Same Bank" && this.beneficiaryData["selectedflowType"] === "ADD") {
...
return false;
    ...
    constructDVFInput: function(beneficiaryType) {
      ...
      try{
        ...
        if(beneficiaryType ==="P2P"){
          ...
          radioValue === "Email" ? p2pJson["Email"]=this.view.lblDetailValue5.text : 
          p2pJson["Phone Number"] = this.view.lblDetailValue5.text;
          return p2pJson;
        }
      }
      catch(err){
      ...
      try{        
        ...
        if (parsedValue8) {
          ...
          if (parsedValue8 && retrieveEntitlement) {                        
            this.view.btnAddAnotherRecipient.text = parsedValue8.text;
        ...
        if (parsedValue9) {
          ...
          if (parsedValue9 && retrieveEntitlement) {                        
            this.view.btnNewTransfer.text = parsedValue9.text;
    ...
    p2pcontactInfoRadio: function() {
      try{
        ...
        if(lbl6TextValue){
          ...
          this.view.flxDetails.flxRecipientDetails.flxDetail6.flxDetailValue6.lbl1.text = optionValues[0];
          this.view.flxDetails.flxRecipientDetails.flxDetail6.flxDetailValue6.lbl2.text = optionValues[1];
          if(textInputRequired){
            if(this.beneficiaryData["selectedRadioTextInputValue"]){
              this.p2pRadioValues();
            }
            this.view.flxDetails.flxRecipientDetails.flxDetail6.flxDetailValue6.img1.onTouchEnd = this.p2pRadioSelection.bind(scope,this.view.flxDetails.flxRecipientDetails.flxDetail6.flxDetailValue6.img1,optionValues[0]);
            this.view.flxDetails.flxRecipientDetails.flxDetail6.flxDetailValue6.img2.onTouchEnd = this.p2pRadioSelection.bind(scope,this.view.flxDetails.flxRecipientDetails.flxDetail6.flxDetailValue6.img2,optionValues[1]);
          }
        }
        else
  ...
  */
    p2pRadioValues: function() {
      ...
      try{
        ...
        if(this.beneficiaryData["selectedradioButtonValue"] === "Phone Number") {
          this.view.flxDetails.flxRecipientDetails.flxDetail6.flxDetailValue6.img1.src = "radiobtn_active.png";
          this.view.flxDetails.flxRecipientDetails.flxDetail6.flxDetailValue6.img2.src = "radio_btn_inactive.png";
        }
        else if(this.beneficiaryData["selectedradioButtonValue"] === "Email") {
  ...
  */
    p2pRadioSelection: function(Button, Key) {
      var self = this;
      try{
        var radioLabelConfig=this.getParsedValue
        (this._radioInputTextLabel,this.beneficiaryData["selectedBeneficiaryType"]);
      ...
      try{
        ...
        if(tbx1PlaceHolder!=null && tbx1PlaceHolder.text!=null && tbx1PlaceHolder.text!=undefined){
          ...
          if(tbx1PlaceHolder.inputMode) {
            if(tbx1PlaceHolder.inputMode === "NUMERIC" && tbx1PlaceHolder.isMaskingEnabled === true) {
              this.view.flxDetails.flxRecipientDetails.flxDetail1.lblDetailValue1.restrictCharactersSet
                ="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ~!@#$%^&*()_-\\?/+={[]}:;,.<>'`|\"";
            }
            else if(tbx1PlaceHolder.inputMode === "NUMERIC" && tbx1PlaceHolder.isMaskingEnabled === false) {
              this.view.flxDetails.flxRecipientDetails.flxDetail1.lblDetailValue1.textInputMode 
                = constants.TEXTBOX_INPUT_MODE_NUMERIC;
            }
            else {
              this.view.flxDetails.flxRecipientDetails.flxDetail1.lblDetailValue1.restrictCharactersSet
          ...
          if(tbx1PlaceHolder.tooltip) {
            this.view.flxDetails.flxRecipientDetails.flxDetail1.lblDetailValue1.toolTip = tbx1PlaceHolder.tooltip;
          }
        }	 
        ...
        if(tbx2PlaceHolder!=null && tbx2PlaceHolder.text!=null && tbx2PlaceHolder.text!=undefined){
          ...
          if(tbx2PlaceHolder.inputMode) {
            if(tbx2PlaceHolder.inputMode === "NUMERIC" && tbx2PlaceHolder.isMaskingEnabled === true) {
              this.view.flxDetails.flxRecipientDetails.flxDetail2.lblDetailValue2.restrictCharactersSet
                ="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ~!@#$%^&*()_+={[]}";
            }
            else if(tbx2PlaceHolder.inputMode === "NUMERIC" && tbx2PlaceHolder.isMaskingEnabled === false) {
              this.view.flxDetails.flxRecipientDetails.flxDetail2.lblDetailValue2.textInputMode
                = constants.TEXTBOX_INPUT_MODE_NUMERIC;
            }
            else {
              this.view.flxDetails.flxRecipientDetails.flxDetail2.lblDetailValue2.restrictCharactersSet
          ...
          if(tbx2PlaceHolder.tooltip) {
            this.view.flxDetails.flxRecipientDetails.flxDetail2.lblDetailValue2.toolTip = tbx2PlaceHolder.tooltip;
          }
        }	  
        ...
        if(tbx3PlaceHolder!=null && tbx3PlaceHolder.text!=null && tbx3PlaceHolder.text!=undefined){
          ...
          if(tbx3PlaceHolder.inputMode) {
            if(tbx3PlaceHolder.inputMode === "NUMERIC" && tbx3PlaceHolder.isMaskingEnabled === true) {
              this.view.flxDetails.flxRecipientDetails.flxDetail3.lblDetailValue3.restrictCharactersSet =
                "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ~!@#$%^&*()_+={[]}";
            }
            else if(tbx3PlaceHolder.inputMode === "NUMERIC" && tbx3PlaceHolder.isMaskingEnabled === false) {
              this.view.flxDetails.flxRecipientDetails.flxDetail3.lblDetailValue3.textInputMode 
                = constants.TEXTBOX_INPUT_MODE_NUMERIC;
            }
            else {
              this.view.flxDetails.flxRecipientDetails.flxDetail3.lblDetailValue3.restrictCharactersSet
          ...
          if(tbx3PlaceHolder.tooltip) {
            this.view.flxDetails.flxRecipientDetails.flxDetail3.lblDetailValue3.toolTip = tbx3PlaceHolder.tooltip;
          }
        }
        ...
        if(tbx4PlaceHolder!=null && tbx4PlaceHolder.text!=null && tbx4PlaceHolder.text!=undefined){
          ...
          if(tbx4PlaceHolder.inputMode) {
            if(tbx4PlaceHolder.inputMode === "NUMERIC" && tbx4PlaceHolder.isMaskingEnabled === true) {
              this.view.flxDetails.flxRecipientDetails.flxDetail4.lblDetailValue4.restrictCharactersSet 
                = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ~!@#$%^&*()_+={[]}";
            }
            else if(tbx4PlaceHolder.inputMode === "NUMERIC" && tbx4PlaceHolder.isMaskingEnabled === false) {
              this.view.flxDetails.flxRecipientDetails.flxDetail4.lblDetailValue4.textInputMode 
                = constants.TEXTBOX_INPUT_MODE_NUMERIC;
            }
            else {
              this.view.flxDetails.flxRecipientDetails.flxDetail4.lblDetailValue4.restrictCharactersSet
          ...
          if(tbx4PlaceHolder.tooltip) {
            this.view.flxDetails.flxRecipientDetails.flxDetail4.lblDetailValue4.toolTip = tbx4PlaceHolder.tooltip;
          }
        }	
        ...
        if(tbx5PlaceHolder!=null && tbx5PlaceHolder.text!=null && tbx5PlaceHolder.text!=undefined){
          ...
          if(tbx5PlaceHolder.inputMode) {
            if(tbx5PlaceHolder.inputMode === "NUMERIC" && tbx5PlaceHolder.isMaskingEnabled === true) {
              this.view.flxDetails.flxRecipientDetails.flxDetail5.lblDetailValue5.restrictCharactersSet
                ="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ~!@#$%^&*()_+={[]}";
            }
            else if(tbx5PlaceHolder.inputMode === "NUMERIC" && tbx5PlaceHolder.isMaskingEnabled === false) {
              this.view.flxDetails.flxRecipientDetails.flxDetail5.lblDetailValue5.textInputMode 
                = constants.TEXTBOX_INPUT_MODE_NUMERIC;
            }
            else {
          ...
          if(tbx5PlaceHolder.tooltip) {
            this.view.flxDetails.flxRecipientDetails.flxDetail5.lblDetailValue5.toolTip = tbx5PlaceHolder.tooltip;
          }
        }	  
