define(['CacheUtils','./BeneficiaryListDAO','./ParserUtilsManager','./FormatUtils','./EntitlementUtils'],function(CacheUtils,BeneficiaryListDAO,ParserUtilsManager,FormatUtils,EntitlementUtils) {
     ...
     */
      ...
      */
      p2pOnClick :function(){
        ...
        this.togglePaginationVisibility(false);
        this.clearSearchText();
        this.view.Column1.onTouchStart = this.onColumnClick.bind(this, this._dataGridColumn1Tab2, "imgColumn1");
        if(!this.isEmptyNullUndefined(this._dataGridColumn2Tab2) && !this.isEmptyNullUndefined(JSON.parse(this._dataGridColumn2Tab2)["sortBy"])){
          this.view.Column2.onTouchStart = this.onColumnClick.bind(this, this._dataGridColumn2Tab2, "imgColumn2");
        ...
        if(!this.isEmptyNullUndefined(this._dataGridColumn3Tab2) && !this.isEmptyNullUndefined(JSON.parse(this._dataGridColumn3Tab2)["sortBy"])){
          this.view.Column3.onTouchStart = this.onColumnClick.bind(this, this._dataGridColumn3Tab2, "imgColumn3");
        ...
        if(!this.isEmptyNullUndefined(this._dataGridColumn4Tab2) && !this.isEmptyNullUndefined(JSON.parse(this._dataGridColumn4Tab2)["sortBy"])){
          this.view.Column4.onTouchStart = this.onColumnClick.bind(this, this._dataGridColumn4Tab2, "imgColumn4");
      ...
      */
      accountsOnClick: function(){
        ...
        if(!this.isEmptyNullUndefined(this._dataGridColumn4Tab1) && !this.isEmptyNullUndefined(JSON.parse(this._dataGridColumn4Tab1)["sortBy"])){
          this.view.Column4.onTouchStart = this.onColumnClick.bind(this, this._dataGridColumn4Tab1, "imgColumn4");
          this.view.imgColumn4.setVisibility(true);
        }else{
          this.view.imgColumn4.setVisibility(false);
        }
