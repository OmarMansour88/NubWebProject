define(function() {
  var konyLoggerModule = require('com/InfinityMB/RegionalTransfer/socialshare/konyLogger');
  var konymp = konymp || {};
        ...
        this.getNativeController = function() {
            try {
                ...
                if (this.nativeControllerInstance === undefined) {
                    ...
                    var nativeControllerPath = 'com/InfinityMB/RegionalTransfer/' + 'socialshare' + '/NativeController' + platformName + '.js';
