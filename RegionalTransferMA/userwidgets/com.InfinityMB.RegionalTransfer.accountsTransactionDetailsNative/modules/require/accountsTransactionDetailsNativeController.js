...
/**
      ...
      for(var j = 1; j <= 12; j++){
        ...
        if(!scopeObj.isEmptyNullUndefined(value)){
         this.view['lblDetailsValueTitle'+j].text= value.text;
          if(fieldType === "amount"){
           ...
           this.view['lblDetailsValueTitle'+j].skin = currentFieldValueSkin;
          }
          else{
           this.view['lblDetailsValueTitle'+j].skin= scopeObj._sknTransDetailsValue;
          }
        }
        else{
         this.view['lblDetailsValueTitle'+j].text= "";
        }
        if(this.view['lblDetailsTitle'+j].text == "" ||this.view['lblDetailsValueTitle'+j].text== ""){
      ...
      if(this.currentTransactionType === "SwiftPayment") {
       ...
       this.view['lblDetailsValueTitle'+j].skin = this._swiftTransactionSkin;  
        this.view.forceLayout();
        this.criteriaCheque.mediaType = "pdf";
        this.criteriaCheque.page = "0";
        var params = this.criteriaCheque;
       this.view['lblDetailsValueTitle'+j].onTouchEnd= function(){
