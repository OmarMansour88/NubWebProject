...
//       applicationManager.getNavigationManager().navigateTo(frmFastTransfers);
  ...
  TransferFastPresentationController.prototype.fetchFromAccountsNew = function(accountTo, accountFrom, successCall) {
    var configurationManager = applicationManager.getConfigurationManager();
      var temp = applicationManager.getAccountManager().fetchInternalAccountsNew(this.fetchFromAccountSuccessNew, this.fetchFromAccountError);
      var response  = temp;
      return response;
  };
  ...
  */
    ...
    var viewmodel = {};
    //customization
    viewmodel.transferError = response.errorMessage || response.dbpErrMsg;
    this.hideProgressBar();
    this.presentTransfers(viewmodel);
  };
