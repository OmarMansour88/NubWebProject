            ...
            if (applicationManager.getUserPreferencesManager().checkP2PEligibilityForUser() !== "Activated") {
                ...
                managePayeesData = managePayeesData.map(function(payeeRecord) {
                    ...
                    var dataObject = {
                        ...
                        "template": (kony.application.getCurrentBreakpoint() == 640 || responsiveUtils.isMobile) ? "flxFastTransfersRecipientsMobile" : "flxFastTransfersRecipientsUnselected",
                ...
                for (i = 0; i < len; i++) {
                    if (viewModel[i] !== undefined && getMappings({
                        ...
                        var dataObject = {
                            ...
                            "template": (kony.application.getCurrentBreakpoint() == 640 || responsiveUtils.isMobile) ? "flxExternalAccountsFastTransfersMobile" : "flxFastExternalAccountsTransfersUnselected",
                            "txtAccountName": {
                                "text": viewModel[i].nickName,
                                "placeholder": ""
                            },
