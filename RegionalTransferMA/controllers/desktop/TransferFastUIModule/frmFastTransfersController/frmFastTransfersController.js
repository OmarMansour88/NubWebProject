...
define(['commonUtilities', 'FormControllerUtility', 'OLBConstants', 'ViewConstants', 'CampaignUtility'], function(commonUtilities, FormControllerUtility, OLBConstants, ViewConstants, CampaignUtility) {
    ...
    return {
        ...
        init: function() {
            ...
            this.view.imgCancelFilterTo.toolTip = kony.i18n.getLocalizedString("i18n.transfers.Cancel");
            this.view.imgCancelFilterFrom.toolTip = kony.i18n.getLocalizedString("i18n.transfers.Cancel");
        },
        ...
        preShow: function() {
            ...
            this.view.tbxAmountValue.onTouchStart = function() {
                scopeObj.onClickRadioButton(scopeObj.view.flxNUORadioBtn4);
            };
            ...
            commonUtilities.setText(this.view.btnModify, kony.i18n.getLocalizedString("i18n.transfers.Cancel"), commonUtilities.getaccessibilityConfig());
            ...
            this.view.tbxAmount2.onEndEditing = function() {
                ...
                if (self.view.tbxAmount2.text == "" || self.view.tbxAmount2.text == null || self.view.tbxAmount2.text == "0" || self.view.tbxAmount2.text == "0.00") {
                    ...
                    commonUtilities.setText(self.view.tbxAmount2, commonUtilities.formatCurrencyWithCommas(self.view.tbxAmount2.text, false, globalacc.currency), commonUtilities.getaccessibilityConfig());
            ...
            this.view.imgRadioPayOtherAmount.onTouchEnd = function() {
                self.view.flxMakeTransferError.setVisibility(false);
                ...
                self.view.lblDueAmount.text = "(Current Due: " + commonUtilities.formatCurrencyWithCommas(globalacc.dueAmount, false, applicationManager.getFormatUtilManager().getCurrencySymbol(globalacc.currency)) + ", Total Overdue: " + commonUtilities.formatCurrencyWithCommas(globalacc.dueTotalAmount, false, applicationManager.getFormatUtilManager().getCurrencySymbol(globalacc.currency)) + ")";
                self.view.lblDueDate3.text = ("(Due Date:" + globalacc.dueDate + ")");
                if (self.view.tbxAmount2.text == "" || self.view.tbxAmount2.text == null || self.view.tbxAmount2.text == "0" || self.view.tbxAmount2.text == "0.00") {
                    self.view.tbxAmount2.text = "0.00";
                    FormControllerUtility.disableButton(self.view.btnPayAmount);
                } else {
            ...
            this.view.imgRadioPayDueAmount.onTouchEnd = function() {
                self.view.flxMakeTransferError.setVisibility(false);
                self.view.tbxAmount2.text = applicationManager.getFormatUtilManager().formatAmount(globalacc.dueAmount);
            ...
            this.confirmscreen = function() {
                self.view.lblConfirmationTitle.text = "Confirm Due Payment";
                ...
                if (self.view.tbxOptional.text == "" || self.view.tbxOptional.text == null) {
                    self.view.tbxOptional.text = "Pay Due"
                }
                if (payOther == 1) {
                    payOtherPartial == 0;
                    payDuePartial === 0;
                    ...
                    if (globalacc.action == "transferDue") {
                        ...
                        var presentationController = applicationManager.getModulesPresentationController({"moduleName" : "LoanPayModule", "appName" : "RegionalTransferMA"});
                        ...
                        self.view.confirmation.lblKeyYourBill.text = "You are paying:";
                        ...
                        self.view.confirmation.lblKeyYouArePaying.text = "Due Date:";
                        self.view.confirmation.lblValueYouArePaying.text = presentationController.getFormattedDateString(self.dueShownDate);
                        self.view.confirmation.lblKeyBalanceAmount.text = "Your Payment Date:";
                        ...
                        if (self.getDateObject(self.selectedDate).getTime() > self.getDateObject(self.dueShownDate).getTime()) {
                            ...
                            self.view.confirmation.lblError.text = "You are paying after due date. This may incur late payment charges.";
                            payDuePartial = 1;
                        } else {
                            payDuePartial = 0;
                            self.view.confirmation.flxPartialPayment.setVisibility(false);
                        ...
                        if (self.getDateObject(self.selectedDate).getTime() > self.getDateObject(self.dueShownDate).getTime()) {
                            ...
                            if (data.balance > due || data.amount == globalacc.dueAmount || data.balance < 0) {
                                ...
                                self.view.confirmation.flxContainerYouArePaying.setVisibility(true);
                                self.view.confirmation.flxContainerBalanceAmount.setVisibility(true);
                                self.view.confirmation.lblKeyYourBill.text = "Current Due:";
                                ...
                                self.view.confirmation.lblKeyYouArePaying.text = "You are paying:";
                                ...
                                self.view.confirmation.lblKeyBalanceAmount.text = "Balance Amount:";
                                ...
                                self.view.confirmation.lblKeyPartialDate.text = "Date:";
            ...
            this.successDue = function(data, refId) {
                self.view.lblAcknowledgementTitle.text = "Acknowledgement-Due Payment";
                self.view.flxConfirmation.setVisibility(false);
                ...
                self.view.acknowledgment.lblTransactionMessage.text = "Your transaction has been done successfully. Payments may take 2-3 business days to be reflected in your loan account";
                ...
                if (payDuePartial == 1) {
                    ...
                    self.view.confirmDialog.lblKeyBalanceAmount.text = "Due Date:";
                    self.view.confirmDialog.lblValueBalanceAmount.text = data.dueDate;
                    self.view.confirmDialog.lblKeyPayDate.text = "Your Payment Date:";
            ...
            this.successOther = function(data, refId) {
                ...
                if (payOtherPartial == 0) {
                    if (payDuePartial === 0) {
                        ...
                        self.view.confirmDialog.flxPartial.setVisibility(true);
                        self.view.confirmDialog.flxContainerBillAmount.setVisibility(true);
                        self.view.confirmDialog.lblKeyBillAmount.text = "Current Due:";
                        ...
                        self.view.confirmDialog.lblValuePaying.text = commonUtilities.formatCurrencyWithCommas(data.amount, false, applicationManager.getFormatUtilManager().getCurrencySymbol(data.toAccountCurrency));
                        self.view.confirmDialog.lblKeyBalanceAmount.text = "Balance Amount:";
                        ...
                        self.view.confirmDialog.lblKeyPayDate.text = "Date:";
        ...
        toggleCreditCardFlexes: function(flag) {
            ...
            if (flag === true) {
                ...
                self.view.lblNoOfRecOrEndingOn.setVisibility(true);
            } else {
        ...
        setpayDue: function(account) {
            ...
            this.view.lblDueAmount.text = "(Current Due: " + commonUtilities.formatCurrencyWithCommas(this.dueCurrentAmount, false, applicationManager.getFormatUtilManager().getCurrencySymbol(account[0].currencyCode)) + ", Total Overdue: " + commonUtilities.formatCurrencyWithCommas(globalacc.dueTotalAmount, false, applicationManager.getFormatUtilManager().getCurrencySymbol(account[0].currencyCode)) + ")";
        ...
        validateDate: function() {
            ...
            if (scopeObj.getDateObject(this.selectedDate).getTime() > scopeObj.getDateObject(this.dueShownDate).getTime()) {
                if (globalacc.dueAmount == 0.00) {
                    ...
                    this.view.flxMakeTransferError.setVisibility(true);
                    this.view.rtxMakeTransferError.text = "Currently there are no pending dues on your account";
                } else {
        ...
        onToAccountChange: function(editTransaction) {
            ...
            if (editTransaction.accountTo) {
                ...
                commonUtilities.setText(this.view.txtTransferTo, name, commonUtilities.getaccessibilityConfig());
                commonUtilities.setText(this.view.lblSelectAccountTo, name, commonUtilities.getaccessibilityConfig());
                commonUtilities.setText(this.view.lblToAmount, selectedCard.bankName, commonUtilities.getaccessibilityConfig());
            } else {
                commonUtilities.setText(this.view.txtTransferTo, this.view.segTransferTo.selectedRowItems[0].lblAccountName, commonUtilities.getaccessibilityConfig());
                commonUtilities.setText(this.view.lblSelectAccountTo, this.view.segTransferTo.selectedRowItems[0].lblAccountName, commonUtilities.getaccessibilityConfig());
                commonUtilities.setText(this.view.lblToAmount, this.view.segTransferTo.selectedRowItems[0].lblAmount, commonUtilities.getaccessibilityConfig());
            }
            ...
            if (selectedCard.lblAccType == "Loan") {
                ...
                if (globalacc.nextdue == null || globalacc.nextdue == undefined)
                    globalacc.nextdue = "0.00";
                this.view.tbxAmount2.text = String(globalacc.nextDueAmount);
                this.view.lblDueAmount.text = ("(Current Due: " + this.view.lblDollar.text + globalacc.nextdue + ", Total Overdue: " + this.view.lblDollar.text + globalacc.totaldue + ")");
                this.view.lblDueDate3.text = ("(Due Date:" + globalacc.nextduedate + ")");
                if (this.view.tbxAmount2.text == "" || this.view.tbxAmount2.text == null || this.view.tbxAmount2.text == "0" || this.view.tbxAmount2.text == "0.00") {
                    this.view.tbxAmount2.text = "0.00";
                    FormControllerUtility.disableButton(this.view.btnPayAmount);
                ...
                var presentationController = applicationManager.getModulesPresentationController({"moduleName" : "TransferFastUIModule", "appName" : "RegionalTransferMA"});
                ...
                if (selectedCard.CreditCard || selectedCard.accountType === "CreditCard") {
                    ...
                    commonUtilities.setText(this.view.lblDueDate, "(" + (selectedCard.CreditCard.dueDate ? (kony.i18n.getLocalizedString("i18n.billPay.DueDate") + ": ") : "") + this.getDateFromDateStr(selectedCard.CreditCard.dueDate) + ")", commonUtilities.getaccessibilityConfig());
                    commonUtilities.setText(this.view.lblCurrentBalanceValue, commonUtilities.formatCurrencyWithCommas(selectedCard.CreditCard.currentBalance, false, selectedCard.CreditCard.currencyCode), commonUtilities.getaccessibilityConfig());
                    commonUtilities.setText(this.view.lblStatementBalanceValue, commonUtilities.formatCurrencyWithCommas(selectedCard.CreditCard.lastStatementBalance, false, selectedCard.CreditCard.currencyCode), commonUtilities.getaccessibilityConfig());
                    commonUtilities.setText(this.view.lblMinimumDueBalanceValue, commonUtilities.formatCurrencyWithCommas(selectedCard.CreditCard.minimumDue, false, selectedCard.CreditCard.currencyCode), commonUtilities.getaccessibilityConfig());
          ...
          for(i=0; i<data.length; i++)
          {
            for(j = 0; j < data[i][1].length; j++)
            {
              if(j === data[i][1].length-1)
                data[i][1][j].lblSeparator.isVisible = false;
            }
          }
            return data;
        },
            ...
            accounts.forEach(function(account) {
                ...
                if (type === "from") {
                  accountType = "Personal Accounts";
                    ...
                    else if (account.PayPersonId) {account.accountType = "PayAPerson"; accountType = "PayAPerson"; }
                }
                if (finalData.hasOwnProperty(accountType)) {
                    ...
                    //if (account.isBusinessAccount === "true") prioritizeAccountTypes.push(accountType);
                  	if(accountType !== "Personal Accounts" && accountType !== "My Personal Accounts")
                            ...
                            flxDropDown: {
                                "onClick": function(context) {
                                    if (type === "from")
                                        ...
                                        scopeObj.view.flxToSegment.setVisibility(true);
        ...
        showOrHideAccountRows: function(context, type) {
            ...
            if (type === "from")
                ...
                var segData = this.view.segTransferTo.data;
        ...
        updateKeyAt: function(widgetName, value, row, section, type) {
            if (type === "from")
                ...
                var data = this.view.segTransferTo.data;
            ...
            if (type === "from")
                ...
                this.view.segTransferTo.setDataAt(rowDataTobeUpdated, row, section);
        },
        ...
        getBankIcon: function(bankName) {
            ...
            if (!kony.sdk.isNullOrUndefined(bankName)) {
                if (bankName.toLowerCase().includes("citi"))
                    ...
                    img = ViewConstants.IMAGES.INFINITY_BANK_IMAGE;
                else
                    img = ViewConstants.IMAGES.EXTERNAL_BANK_IMAGE;
            }
            return img;
        },
        /** Creates the segment data along with Section Headers
        ...
        segFromAccountRowClick: function(toAccounts, p2pEnabledStatus, p2pServiceStatus) {
            ...
            commonUtilities.setText(this.view.lblFromAmount, selectedAccount.lblAmount, commonUtilities.getaccessibilityConfig());
            this.view.flxFromSegment.setVisibility(false);
        ...
        updateMakeTransferForm: function(makeTransferViewModel) {
            ...
            if (makeTransferViewModel.fromAccounts) {
                if (makeTransferViewModel.fromAccounts.length > 0) {
                    ...
                    if (makeTransferViewModel.isSearch) {
                        ...
                        commonUtilities.setText(this.view.lblNoResultsFrom, kony.i18n.getLocalizedString("i18n.FastTransfers.NoResultsFound"), commonUtilities.getaccessibilityConfig());
                        this.view.flxNoResultsFrom.setVisibility(true);
                    } else {
                        this.view.segTransferFrom.setVisibility(false);
                        commonUtilities.setText(this.view.lblNoResultsFrom, kony.i18n.getLocalizedString("i18n.FastTransfers.NoAccountsToTransferFrom"), commonUtilities.getaccessibilityConfig());
                        this.view.flxNoResultsFrom.setVisibility(true);
                    }
                }
            }
            if (makeTransferViewModel.toAccounts) {
                if (makeTransferViewModel.toAccounts.length > 0) {
                    ...
                    if (makeTransferViewModel.p2pEnabled === true && makeTransferViewModel.p2pSuccess === false) {
                        ...
                        this.view.segTransferTo.setVisibility(false);
                        this.view.flxNoResultsToPayPersonFailure.setVisibility(false);
                        commonUtilities.setText(this.view.lblNoResultsFrom, kony.i18n.getLocalizedString("i18n.FastTransfers.NoRecipient"), commonUtilities.getaccessibilityConfig());
                        this.view.flxNoResultsTo.setVisibility(true);
                    }
                }
            }
            ...
            if (kony.sdk.isNullOrUndefined(this.view.segTransferTo.selectedRowItems))
        ...
        prefillToAccount: function(accountTo, toAccountsList, widgetToData) {
            ...
            var accType = "";
            if (account[0].isInternationalAccount === "true") {
                accType = "International Account";
                this.showCurrency();
            }
            else if (account[0].isSameBankAccount === "true")
                accType = "Infinity Account";
            else if (!kony.sdk.isNullOrUndefined(account[0].PayPersonId))
                accType = "Person-to-Person";
            let toTextboxText = "", toLabelText = "";
            ...
            this.view.txtTransferTo.setVisibility(false);
            this.view.flxCancelFilterTo.setVisibility(false);
            commonUtilities.setText(this.view.lblToAmount, ((account[0].accountType !== "CreditCard") && (account[0].accountType !== "Loan")) ? (account[0].availableBalance ? commonUtilities.formatCurrencyWithCommas(account[0].availableBalance, false, account[0].currencyCode) : (account[0].bankName || account[0].phone || account[0].email)) : (commonUtilities.formatCurrencyWithCommas(account[0].outstandingBalance, false, account[0].currencyCode)), commonUtilities.getaccessibilityConfig());
            //if(configurationManager.isCombinedUser==="true"){
            if (this.profileAccess === "both") {
        ...
        onFrequencyChanged: function() {
            ...
            if(this.view.lbxFrequency.selectedKey !== "Once"){
                // Convert 6-element array to Date object

                const arrayToDate = (arr) => new Date(
                    arr[2],  // year
                    arr[1] - 1,  // month (0-indexed)
                    arr[0],  // day
                    arr[3] || 0,  // hours
                    arr[4] || 0,  // minutes
                    arr[5] || 0   // seconds
                ...
                // Convert Date back to 6-element array
                ...
                // Get today's date (without time component for date comparison)
                const today = new Date();
                const todayAtMidnight = new Date(today.getFullYear(), today.getMonth(), today.getDate());
            
                // Process send date
                let sendDate = arrayToDate(this.view.calSendOnNew.dateComponents);
                const sendDateAtMidnight = new Date(sendDate.getFullYear(), sendDate.getMonth(), sendDate.getDate());
            
                // If send date (date only) is today, increment by 1 day (keeping original time)
                if (sendDateAtMidnight.getTime() === todayAtMidnight.getTime()) {
                    sendDate.setDate(sendDate.getDate() + 1);
                }
            
                // Process end date
                let endDate = arrayToDate(this.view.calEndingOnNew.dateComponents);
                const endDateAtMidnight = new Date(endDate.getFullYear(), endDate.getMonth(), endDate.getDate());
                const sendDateAtMidnightNew = new Date(sendDate.getFullYear(), sendDate.getMonth(), sendDate.getDate());
            
                // If end date (date only) is before send date, make it equal to send date (keeping original time)
                if (endDateAtMidnight.getTime() < sendDateAtMidnightNew.getTime()) {
                    endDate = new Date(sendDate); // Clone the send date
                    // Preserve original end time if you prefer, otherwise it takes send date's time
                    // endDate.setHours(calEndingOnNew[3], calEndingOnNew[4], calEndingOnNew[5]);
                }
            
               
                this.view.calSendOnNew.dateComponents = dateToArray(sendDate)
                this.view.calEndingOnNew.dateComponents = dateToArray(endDate)
        ...
        checkValidityMakeFastTransferForm: function() {
            this.view.tbxNoOfRecurrences.skin = ViewConstants.SKINS.RECURRENCE_FIELD_FAST_TRANSFER;
            ...
            if (formData.frequencyKey !== "Once" && formData.howLongKey === "NO_OF_RECURRENCES" && (formData.noOfRecurrences === null || formData.noOfRecurrences === "" || formData.noOfRecurrences === '0' || (isNaN(formData.noOfRecurrences) || !Number.isInteger(Number.parseFloat(formData.noOfRecurrences)) || Number.parseFloat(formData.noOfRecurrences) <= 0))) {
                commonUtilities.disableButton(this.view.btnConfirm);
                return;
            }
        ...
        showFieldErrorMinMaxError: function(errorMsg) {
            this.view.lblWarning.setVisibility(true);
            commonUtilities.setText(this.view.lblWarning, errorMsg, commonUtilities.getaccessibilityConfig());
        },
