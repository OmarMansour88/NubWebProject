...
define(['commonUtilities', 'OLBConstants', 'ViewConstants', 'FormControllerUtility'], function(commonUtilities, OLBConstants, ViewConstants, FormControllerUtility) {
   ...
   */
        ...
        updateTransferReviewDetails: function(transferConfirm) {
            ...
            commonUtilities.setText(this.view.lblKey, kony.i18n.getLocalizedString("i18n.transfers.TransferFrom") + ":", commonUtilities.getaccessibilityConfig());
            ...
            commonUtilities.setText(this.view.lblToKey, kony.i18n.getLocalizedString("i18n.transfers.TransferTo") + ":", commonUtilities.getaccessibilityConfig());
            commonUtilities.setText(this.view.lblToValue, viewModel.accountTo.beneficiaryName ? (viewModel.accountTo.nickName) + " ...." + commonUtilities.getLastFourDigit(viewModel.accountTo.accountNumber) : (viewModel.accountTo.PayPersonId ? (viewModel.accountTo.nickName ? viewModel.accountTo.nickName : viewModel.accountTo.name) : (commonUtilities.getAccountDisplayName(viewModel.accountTo))), commonUtilities.getaccessibilityConfig());
            ...
            commonUtilities.setText(this.view.lblDateKey, kony.i18n.getLocalizedString("i18n.transfers.TransferDate") + ":", commonUtilities.getaccessibilityConfig());
            ...
            commonUtilities.setText(this.view.lblDurationKey, kony.i18n.getLocalizedString("i18n.transfers.Duration") + ":", commonUtilities.getaccessibilityConfig());
            this.view.flxFrequency.setVisibility(true);
            commonUtilities.setText(this.view.lblNoteKey, kony.i18n.getLocalizedString("i18n.accounts.Note") + ":", commonUtilities.getaccessibilityConfig());
            if (viewModel.notes === "")
                this.view.lblNoteValue.text = "-";
            else
                commonUtilities.setText(this.view.lblNoteValue, viewModel.notes, commonUtilities.getaccessibilityConfig());
            if (viewModel.frequencyKey !== kony.i18n.getLocalizedString("i18n.transfers.frequency.once") && viewModel.howLongKey === "ON_SPECIFIC_DATE") {
                ...
                commonUtilities.setText(this.view.lblEndDateKey, kony.i18n.getLocalizedString("i18n.transfers.endby") + ":", commonUtilities.getaccessibilityConfig());
            ...
            this.view.btnModify.onClick = function() {
                applicationManager.getModulesPresentationController({"moduleName" : "TransferFastUIModule", "appName" : "RegionalTransferMA"}).modifyTransaction(transferConfirm);
            }.bind(this);
        ...
        saveTransfer: function(transferConfirm) {
            ...
            if (transferConfirm.makeTransferViewModel.editTransaction) {
                applicationManager.getModulesPresentationController({"moduleName" : "TransferFastUIModule", "appName" : "RegionalTransferMA"}).editTransfer(this.updateTransactionObject(transferConfirm.makeTransferViewModel.editTransaction.editTransactionObject, transferConfirm.transferData));
            } else {
        ...
        filterTransferData: function(transferData, serviceName) {
            ...
            applicationManager.getModulesPresentationController({"moduleName" : "TransferFastUIModule", "appName" : "RegionalTransferMA"}).createTransfer(commandData);
        },
