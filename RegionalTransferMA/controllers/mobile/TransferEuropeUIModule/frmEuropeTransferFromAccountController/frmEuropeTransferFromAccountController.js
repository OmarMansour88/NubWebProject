define({
  ...
  navigateCustomBack: function () {
    ...
    if (entryPoint === "frmEuropeTransferFromAccount" || entryPoint === "frmDashboardAggregated") {
      ...
      var transMod = applicationManager.getModulesPresentationController({"moduleName" : "ManageActivitiesUIModule", "appName" : "UnifiedTransferMA"});
