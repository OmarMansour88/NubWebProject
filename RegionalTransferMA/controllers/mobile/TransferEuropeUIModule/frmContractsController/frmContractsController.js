define({
  ...
  btnContinueOnClick: function() {
    ...
    if(previousForm === "frmBillPayPayeeDetails" || previousForm === "frmBillPayReEnterAccNo" || previousForm === "frmBillPayEnterAccNo"
      ...
      var transferModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("TransferEuropeUIModule");
  ...
  setDataForEuropeBenificiary: function() {
    var scope=this;
    var transferModulePresController = applicationManager.getModulesPresentationController("TransferEuropeUIModule");
