 ...
 preShow: function () {
  ...
  onClickCancel: function() {
    var navManager = applicationManager.getNavigationManager();
        ...
        if (navigateToForm==="frmBeneficiaryDetailsEurope") {
            var transferEurModPresentationController = applicationManager.getModulesPresentationController({"moduleName" : "ManageActivitiesUIModule", "appName" : "UnifiedTransferMA"});
            transferEurModPresentationController.commonFunctionForNavigation({"friendlyName" : "ManageActivitiesUIModule/frmBeneficiaryDetailsEurope", "appName" : "UnifiedTransferMA"});
        } else {
  ...
  saveChangedBeneficiaryDetails: function(data) {
        ...
        var transferModulePresentationController = applicationManager.getModulesPresentationController({"moduleName" : "ManageActivitiesUIModule", "appName" : "UnifiedTransferMA"});
