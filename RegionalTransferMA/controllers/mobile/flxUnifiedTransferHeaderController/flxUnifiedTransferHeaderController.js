 ...
 onViewCreated:function(){
  ...
  rowOnClick :function(eventobject,context){
    try{
      ...
      if(formName ==="UnifiedTransferFlowNew/frmSameBankNew"|| formName ==="UnifiedTransferFlowNew/frmDomesticTransferNew" ||
         formName ==="UnifiedTransferFlowNew/frmP2PTransferNew" || formName ==="UnifiedTransferFlowNew/frmInternationalTransferNew"){
