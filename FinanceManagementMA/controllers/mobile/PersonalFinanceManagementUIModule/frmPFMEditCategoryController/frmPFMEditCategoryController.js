  ...
  init : function(){
            ...
            this.view.segCategories.onRowClick = function() {
              try {
                ...
                for (var i = 0; i < newData.length; i++) {
                    newData[i].flxArrow.skin = "slFboxmb";
        ...
        try {
            ...
            categories.forEach(function(category) {
                ...
                if (selectedCategory === category.categoryId) {
                    tempJs = self.setRowCategory("sknflxf1f1f1Rounded", "tickmark_green.png", true);
                } else {
                    tempJs = self.setRowCategory("slFboxmb", "tickmark_green.png", false);
                }
    ...
    updateTransaction: function() {
        try {
            ...
            pfmMod.presentationController.updatePFMTransaction(transactionRecord, this.updateTransactionSuccess.bind(this), this.updateTransactionFailure.bind(this));
        }
        catch(err) {
          applicationManager.getPresentationUtility().dismissLoadingScreen();
    ...
    updateTransactionSuccess: function(response) {
        try {
			...
			currentTransaction.isCategoryUpdated='true';
